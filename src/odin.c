...
SEXP odin_model_determ_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 424));
  ...
  SET_VECTOR_ELT(contents, 366, ScalarInteger(internal->offset_output_prop_wb));
  SET_VECTOR_ELT(contents, 367, ScalarInteger(internal->offset_output_R0t_1));
  SET_VECTOR_ELT(contents, 368, ScalarInteger(internal->offset_variable_I1));
  SET_VECTOR_ELT(contents, 369, ScalarInteger(internal->offset_variable_incubA));
  SET_VECTOR_ELT(contents, 370, ScalarInteger(internal->offset_variable_incubB));
  SET_VECTOR_ELT(contents, 371, ScalarInteger(internal->offset_variable_infectiousA));
  SET_VECTOR_ELT(contents, 372, ScalarInteger(internal->offset_variable_infectiousB));
  SET_VECTOR_ELT(contents, 373, ScalarInteger(internal->offset_variable_Lwb));
  SET_VECTOR_ELT(contents, 374, ScalarInteger(internal->offset_variable_Mwb_E1));
  SET_VECTOR_ELT(contents, 375, ScalarInteger(internal->offset_variable_Mwb_E2));
  SET_VECTOR_ELT(contents, 376, ScalarInteger(internal->offset_variable_Mwb_I1));
  SET_VECTOR_ELT(contents, 377, ScalarInteger(internal->offset_variable_Mwb_S));
  SET_VECTOR_ELT(contents, 378, ScalarInteger(internal->offset_variable_Mwt_E1));
  SET_VECTOR_ELT(contents, 379, ScalarInteger(internal->offset_variable_Mwt_E2));
  SET_VECTOR_ELT(contents, 380, ScalarInteger(internal->offset_variable_Mwt_I1));
  SET_VECTOR_ELT(contents, 381, ScalarInteger(internal->offset_variable_R1));
  SET_VECTOR_ELT(contents, 382, ScalarInteger(internal->offset_variable_S));
  SET_VECTOR_ELT(contents, 383, ScalarReal(internal->Omega));
  SEXP phi1 = PROTECT(allocVector(REALSXP, internal->dim_phi1));
  memcpy(REAL(phi1), internal->phi1, internal->dim_phi1 * sizeof(double));
  SET_VECTOR_ELT(contents, 384, phi1);
  SET_VECTOR_ELT(contents, 385, ScalarReal(internal->pi));
  ...
  SET_VECTOR_ELT(contents, 386, prop_wb);
  SET_VECTOR_ELT(contents, 387, ScalarReal(internal->propMwtControl));
  SET_VECTOR_ELT(contents, 388, ScalarReal(internal->propTransGlobal));
  SET_VECTOR_ELT(contents, 389, ScalarReal(internal->propTransNN));
  ...
  SET_VECTOR_ELT(contents, 390, R0t_1);
  ...
  SET_VECTOR_ELT(contents, 391, recov1);
  ...
  SET_VECTOR_ELT(contents, 392, recov1_prob);
  SEXP rho1 = PROTECT(allocVector(REALSXP, internal->dim_rho1));
  memcpy(REAL(rho1), internal->rho1, internal->dim_rho1 * sizeof(double));
  SET_VECTOR_ELT(contents, 393, rho1);
  SET_VECTOR_ELT(contents, 394, ScalarReal(internal->Rm));
  ...
  SET_VECTOR_ELT(contents, 395, season_amp);
  ...
  SET_VECTOR_ELT(contents, 396, season_phases);
  SET_VECTOR_ELT(contents, 397, ScalarReal(internal->Sigma));
  SET_VECTOR_ELT(contents, 398, ScalarReal(internal->TimeMwtControlOff));
  SET_VECTOR_ELT(contents, 399, ScalarReal(internal->TimeMwtControlOn));
  ...
  SET_VECTOR_ELT(contents, 400, vacc_child_age);
  SET_VECTOR_ELT(contents, 401, ScalarReal(internal->vacc_child_coverage));
  SET_VECTOR_ELT(contents, 402, ScalarReal(internal->vacc_child_starttime));
  SET_VECTOR_ELT(contents, 403, ScalarReal(internal->vacc_child_stoptime));
  ...
  SET_VECTOR_ELT(contents, 404, vacc_cu_age);
  SET_VECTOR_ELT(contents, 405, ScalarReal(internal->vacc_cu_coverage));
  SET_VECTOR_ELT(contents, 406, ScalarReal(internal->vacc_cu_rndtime));
  ...
  SET_VECTOR_ELT(contents, 407, vacc_noncov);
  ...
  SET_VECTOR_ELT(contents, 408, vcu_noncov);
  SET_VECTOR_ELT(contents, 409, ScalarInteger(internal->vnc_row));
  SET_VECTOR_ELT(contents, 410, ScalarReal(internal->Wb_cyto));
  SET_VECTOR_ELT(contents, 411, ScalarReal(internal->Wb_fF));
  SET_VECTOR_ELT(contents, 412, ScalarReal(internal->Wb_fM));
  SET_VECTOR_ELT(contents, 413, ScalarReal(internal->Wb_introduration));
  SET_VECTOR_ELT(contents, 414, ScalarReal(internal->Wb_introlevel));
  ...
  SET_VECTOR_ELT(contents, 415, Wb_introrate);
  ...
  SET_VECTOR_ELT(contents, 416, Wb_introtime);
  SET_VECTOR_ELT(contents, 417, ScalarReal(internal->Wb_mat));
  SET_VECTOR_ELT(contents, 418, ScalarReal(internal->Wb_relinf1));
  SET_VECTOR_ELT(contents, 419, ScalarReal(internal->Wb_relsusc1));
  ...
  SET_VECTOR_ELT(contents, 422, Y1T_sum);
  SET_VECTOR_ELT(contents, 423, ScalarReal(internal->YL));
  SEXP nms = PROTECT(allocVector(STRSXP, 424));
  ...
  SET_STRING_ELT(nms, 366, mkChar("offset_output_prop_wb"));
  SET_STRING_ELT(nms, 367, mkChar("offset_output_R0t_1"));
  SET_STRING_ELT(nms, 368, mkChar("offset_variable_I1"));
  SET_STRING_ELT(nms, 369, mkChar("offset_variable_incubA"));
  SET_STRING_ELT(nms, 370, mkChar("offset_variable_incubB"));
  SET_STRING_ELT(nms, 371, mkChar("offset_variable_infectiousA"));
  SET_STRING_ELT(nms, 372, mkChar("offset_variable_infectiousB"));
  SET_STRING_ELT(nms, 373, mkChar("offset_variable_Lwb"));
  SET_STRING_ELT(nms, 374, mkChar("offset_variable_Mwb_E1"));
  SET_STRING_ELT(nms, 375, mkChar("offset_variable_Mwb_E2"));
  SET_STRING_ELT(nms, 376, mkChar("offset_variable_Mwb_I1"));
  SET_STRING_ELT(nms, 377, mkChar("offset_variable_Mwb_S"));
  SET_STRING_ELT(nms, 378, mkChar("offset_variable_Mwt_E1"));
  SET_STRING_ELT(nms, 379, mkChar("offset_variable_Mwt_E2"));
  SET_STRING_ELT(nms, 380, mkChar("offset_variable_Mwt_I1"));
  SET_STRING_ELT(nms, 381, mkChar("offset_variable_R1"));
  SET_STRING_ELT(nms, 382, mkChar("offset_variable_S"));
  SET_STRING_ELT(nms, 383, mkChar("Omega"));
  SET_STRING_ELT(nms, 384, mkChar("phi1"));
  SET_STRING_ELT(nms, 385, mkChar("pi"));
  SET_STRING_ELT(nms, 386, mkChar("prop_wb"));
  SET_STRING_ELT(nms, 387, mkChar("propMwtControl"));
  SET_STRING_ELT(nms, 388, mkChar("propTransGlobal"));
  SET_STRING_ELT(nms, 389, mkChar("propTransNN"));
  SET_STRING_ELT(nms, 390, mkChar("R0t_1"));
  SET_STRING_ELT(nms, 391, mkChar("recov1"));
  SET_STRING_ELT(nms, 392, mkChar("recov1_prob"));
  SET_STRING_ELT(nms, 393, mkChar("rho1"));
  SET_STRING_ELT(nms, 394, mkChar("Rm"));
  SET_STRING_ELT(nms, 395, mkChar("season_amp"));
  SET_STRING_ELT(nms, 396, mkChar("season_phases"));
  SET_STRING_ELT(nms, 397, mkChar("Sigma"));
  SET_STRING_ELT(nms, 398, mkChar("TimeMwtControlOff"));
  SET_STRING_ELT(nms, 399, mkChar("TimeMwtControlOn"));
  SET_STRING_ELT(nms, 400, mkChar("vacc_child_age"));
  SET_STRING_ELT(nms, 401, mkChar("vacc_child_coverage"));
  SET_STRING_ELT(nms, 402, mkChar("vacc_child_starttime"));
  SET_STRING_ELT(nms, 403, mkChar("vacc_child_stoptime"));
  SET_STRING_ELT(nms, 404, mkChar("vacc_cu_age"));
  SET_STRING_ELT(nms, 405, mkChar("vacc_cu_coverage"));
  SET_STRING_ELT(nms, 406, mkChar("vacc_cu_rndtime"));
  SET_STRING_ELT(nms, 407, mkChar("vacc_noncov"));
  SET_STRING_ELT(nms, 408, mkChar("vcu_noncov"));
  SET_STRING_ELT(nms, 409, mkChar("vnc_row"));
  SET_STRING_ELT(nms, 410, mkChar("Wb_cyto"));
  SET_STRING_ELT(nms, 411, mkChar("Wb_fF"));
  SET_STRING_ELT(nms, 412, mkChar("Wb_fM"));
  SET_STRING_ELT(nms, 413, mkChar("Wb_introduration"));
  SET_STRING_ELT(nms, 414, mkChar("Wb_introlevel"));
  SET_STRING_ELT(nms, 415, mkChar("Wb_introrate"));
  SET_STRING_ELT(nms, 416, mkChar("Wb_introtime"));
  SET_STRING_ELT(nms, 417, mkChar("Wb_mat"));
  SET_STRING_ELT(nms, 418, mkChar("Wb_relinf1"));
  SET_STRING_ELT(nms, 419, mkChar("Wb_relsusc1"));
  SET_STRING_ELT(nms, 420, mkChar("Y1"));
  SET_STRING_ELT(nms, 421, mkChar("Y1T"));
  SET_STRING_ELT(nms, 422, mkChar("Y1T_sum"));
  SET_STRING_ELT(nms, 423, mkChar("YL"));
