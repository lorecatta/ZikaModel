...
SEXP odin_model_determ_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 425));
  ...
  SET_VECTOR_ELT(contents, 366, ScalarInteger(internal->offset_output_Ntotal));
  SET_VECTOR_ELT(contents, 367, ScalarInteger(internal->offset_output_prop_wb));
  SET_VECTOR_ELT(contents, 368, ScalarInteger(internal->offset_output_R0t_1));
  SET_VECTOR_ELT(contents, 369, ScalarInteger(internal->offset_variable_I1));
  SET_VECTOR_ELT(contents, 370, ScalarInteger(internal->offset_variable_incubA));
  SET_VECTOR_ELT(contents, 371, ScalarInteger(internal->offset_variable_incubB));
  SET_VECTOR_ELT(contents, 372, ScalarInteger(internal->offset_variable_infectiousA));
  SET_VECTOR_ELT(contents, 373, ScalarInteger(internal->offset_variable_infectiousB));
  SET_VECTOR_ELT(contents, 374, ScalarInteger(internal->offset_variable_Lwb));
  SET_VECTOR_ELT(contents, 375, ScalarInteger(internal->offset_variable_Mwb_E1));
  SET_VECTOR_ELT(contents, 376, ScalarInteger(internal->offset_variable_Mwb_E2));
  SET_VECTOR_ELT(contents, 377, ScalarInteger(internal->offset_variable_Mwb_I1));
  SET_VECTOR_ELT(contents, 378, ScalarInteger(internal->offset_variable_Mwb_S));
  SET_VECTOR_ELT(contents, 379, ScalarInteger(internal->offset_variable_Mwt_E1));
  SET_VECTOR_ELT(contents, 380, ScalarInteger(internal->offset_variable_Mwt_E2));
  SET_VECTOR_ELT(contents, 381, ScalarInteger(internal->offset_variable_Mwt_I1));
  SET_VECTOR_ELT(contents, 382, ScalarInteger(internal->offset_variable_R1));
  SET_VECTOR_ELT(contents, 383, ScalarInteger(internal->offset_variable_S));
  SET_VECTOR_ELT(contents, 384, ScalarReal(internal->Omega));
  SEXP phi1 = PROTECT(allocVector(REALSXP, internal->dim_phi1));
  memcpy(REAL(phi1), internal->phi1, internal->dim_phi1 * sizeof(double));
  SET_VECTOR_ELT(contents, 385, phi1);
  SET_VECTOR_ELT(contents, 386, ScalarReal(internal->pi));
  ...
  SET_VECTOR_ELT(contents, 387, prop_wb);
  SET_VECTOR_ELT(contents, 388, ScalarReal(internal->propMwtControl));
  SET_VECTOR_ELT(contents, 389, ScalarReal(internal->propTransGlobal));
  SET_VECTOR_ELT(contents, 390, ScalarReal(internal->propTransNN));
  ...
  SET_VECTOR_ELT(contents, 391, R0t_1);
  ...
  SET_VECTOR_ELT(contents, 392, recov1);
  ...
  SET_VECTOR_ELT(contents, 393, recov1_prob);
  SEXP rho1 = PROTECT(allocVector(REALSXP, internal->dim_rho1));
  memcpy(REAL(rho1), internal->rho1, internal->dim_rho1 * sizeof(double));
  SET_VECTOR_ELT(contents, 394, rho1);
  SET_VECTOR_ELT(contents, 395, ScalarReal(internal->Rm));
  ...
  SET_VECTOR_ELT(contents, 396, season_amp);
  ...
  SET_VECTOR_ELT(contents, 397, season_phases);
  SET_VECTOR_ELT(contents, 398, ScalarReal(internal->Sigma));
  SET_VECTOR_ELT(contents, 399, ScalarReal(internal->TimeMwtControlOff));
  SET_VECTOR_ELT(contents, 400, ScalarReal(internal->TimeMwtControlOn));
  ...
  SET_VECTOR_ELT(contents, 401, vacc_child_age);
  SET_VECTOR_ELT(contents, 402, ScalarReal(internal->vacc_child_coverage));
  SET_VECTOR_ELT(contents, 403, ScalarReal(internal->vacc_child_starttime));
  SET_VECTOR_ELT(contents, 404, ScalarReal(internal->vacc_child_stoptime));
  ...
  SET_VECTOR_ELT(contents, 405, vacc_cu_age);
  SET_VECTOR_ELT(contents, 406, ScalarReal(internal->vacc_cu_coverage));
  SET_VECTOR_ELT(contents, 407, ScalarReal(internal->vacc_cu_rndtime));
  ...
  SET_VECTOR_ELT(contents, 408, vacc_noncov);
  ...
  SET_VECTOR_ELT(contents, 409, vcu_noncov);
  SET_VECTOR_ELT(contents, 410, ScalarInteger(internal->vnc_row));
  SET_VECTOR_ELT(contents, 411, ScalarReal(internal->Wb_cyto));
  SET_VECTOR_ELT(contents, 412, ScalarReal(internal->Wb_fF));
  SET_VECTOR_ELT(contents, 413, ScalarReal(internal->Wb_fM));
  SET_VECTOR_ELT(contents, 414, ScalarReal(internal->Wb_introduration));
  SET_VECTOR_ELT(contents, 415, ScalarReal(internal->Wb_introlevel));
  ...
  SET_VECTOR_ELT(contents, 416, Wb_introrate);
  ...
  SET_VECTOR_ELT(contents, 417, Wb_introtime);
  SET_VECTOR_ELT(contents, 418, ScalarReal(internal->Wb_mat));
  SET_VECTOR_ELT(contents, 419, ScalarReal(internal->Wb_relinf1));
  SET_VECTOR_ELT(contents, 420, ScalarReal(internal->Wb_relsusc1));
  ...
  SET_VECTOR_ELT(contents, 423, Y1T_sum);
  SET_VECTOR_ELT(contents, 424, ScalarReal(internal->YL));
  SEXP nms = PROTECT(allocVector(STRSXP, 425));
  ...
  SET_STRING_ELT(nms, 366, mkChar("offset_output_Ntotal"));
  SET_STRING_ELT(nms, 367, mkChar("offset_output_prop_wb"));
  SET_STRING_ELT(nms, 368, mkChar("offset_output_R0t_1"));
  SET_STRING_ELT(nms, 369, mkChar("offset_variable_I1"));
  SET_STRING_ELT(nms, 370, mkChar("offset_variable_incubA"));
  SET_STRING_ELT(nms, 371, mkChar("offset_variable_incubB"));
  SET_STRING_ELT(nms, 372, mkChar("offset_variable_infectiousA"));
  SET_STRING_ELT(nms, 373, mkChar("offset_variable_infectiousB"));
  SET_STRING_ELT(nms, 374, mkChar("offset_variable_Lwb"));
  SET_STRING_ELT(nms, 375, mkChar("offset_variable_Mwb_E1"));
  SET_STRING_ELT(nms, 376, mkChar("offset_variable_Mwb_E2"));
  SET_STRING_ELT(nms, 377, mkChar("offset_variable_Mwb_I1"));
  SET_STRING_ELT(nms, 378, mkChar("offset_variable_Mwb_S"));
  SET_STRING_ELT(nms, 379, mkChar("offset_variable_Mwt_E1"));
  SET_STRING_ELT(nms, 380, mkChar("offset_variable_Mwt_E2"));
  SET_STRING_ELT(nms, 381, mkChar("offset_variable_Mwt_I1"));
  SET_STRING_ELT(nms, 382, mkChar("offset_variable_R1"));
  SET_STRING_ELT(nms, 383, mkChar("offset_variable_S"));
  SET_STRING_ELT(nms, 384, mkChar("Omega"));
  SET_STRING_ELT(nms, 385, mkChar("phi1"));
  SET_STRING_ELT(nms, 386, mkChar("pi"));
  SET_STRING_ELT(nms, 387, mkChar("prop_wb"));
  SET_STRING_ELT(nms, 388, mkChar("propMwtControl"));
  SET_STRING_ELT(nms, 389, mkChar("propTransGlobal"));
  SET_STRING_ELT(nms, 390, mkChar("propTransNN"));
  SET_STRING_ELT(nms, 391, mkChar("R0t_1"));
  SET_STRING_ELT(nms, 392, mkChar("recov1"));
  SET_STRING_ELT(nms, 393, mkChar("recov1_prob"));
  SET_STRING_ELT(nms, 394, mkChar("rho1"));
  SET_STRING_ELT(nms, 395, mkChar("Rm"));
  SET_STRING_ELT(nms, 396, mkChar("season_amp"));
  SET_STRING_ELT(nms, 397, mkChar("season_phases"));
  SET_STRING_ELT(nms, 398, mkChar("Sigma"));
  SET_STRING_ELT(nms, 399, mkChar("TimeMwtControlOff"));
  SET_STRING_ELT(nms, 400, mkChar("TimeMwtControlOn"));
  SET_STRING_ELT(nms, 401, mkChar("vacc_child_age"));
  SET_STRING_ELT(nms, 402, mkChar("vacc_child_coverage"));
  SET_STRING_ELT(nms, 403, mkChar("vacc_child_starttime"));
  SET_STRING_ELT(nms, 404, mkChar("vacc_child_stoptime"));
  SET_STRING_ELT(nms, 405, mkChar("vacc_cu_age"));
  SET_STRING_ELT(nms, 406, mkChar("vacc_cu_coverage"));
  SET_STRING_ELT(nms, 407, mkChar("vacc_cu_rndtime"));
  SET_STRING_ELT(nms, 408, mkChar("vacc_noncov"));
  SET_STRING_ELT(nms, 409, mkChar("vcu_noncov"));
  SET_STRING_ELT(nms, 410, mkChar("vnc_row"));
  SET_STRING_ELT(nms, 411, mkChar("Wb_cyto"));
  SET_STRING_ELT(nms, 412, mkChar("Wb_fF"));
  SET_STRING_ELT(nms, 413, mkChar("Wb_fM"));
  SET_STRING_ELT(nms, 414, mkChar("Wb_introduration"));
  SET_STRING_ELT(nms, 415, mkChar("Wb_introlevel"));
  SET_STRING_ELT(nms, 416, mkChar("Wb_introrate"));
  SET_STRING_ELT(nms, 417, mkChar("Wb_introtime"));
  SET_STRING_ELT(nms, 418, mkChar("Wb_mat"));
  SET_STRING_ELT(nms, 419, mkChar("Wb_relinf1"));
  SET_STRING_ELT(nms, 420, mkChar("Wb_relsusc1"));
  SET_STRING_ELT(nms, 421, mkChar("Y1"));
  SET_STRING_ELT(nms, 422, mkChar("Y1T"));
  SET_STRING_ELT(nms, 423, mkChar("Y1T_sum"));
  SET_STRING_ELT(nms, 424, mkChar("YL"));
...
SEXP odin_model_determ_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->offset_output_Ntotal = 1 + internal->dim_FOI1 + internal->dim_R0t_1 + internal->dim_Delta + internal->dim_Kc + internal->dim_eip + internal->dim_prop_wb;
  ...
  internal->offset_output_inf_1 = 1 + internal->dim_FOI1 + internal->dim_R0t_1 + internal->dim_Delta + internal->dim_Kc + internal->dim_eip + internal->dim_prop_wb + internal->dim_Ntotal;
...
SEXP odin_model_determ_metadata(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(output_length, 6, ScalarInteger(internal->dim_prop_wb));
  SET_VECTOR_ELT(output_length, 7, allocVector(INTSXP, 3));
  int * dim_Ntotal = INTEGER(VECTOR_ELT(output_length, 7));
  dim_Ntotal[0] = internal->dim_Ntotal_1;
  dim_Ntotal[1] = internal->dim_Ntotal_2;
  dim_Ntotal[2] = internal->dim_Ntotal_3;
  SET_VECTOR_ELT(output_length, 8, allocVector(INTSXP, 3));
  int * dim_inf_1 = INTEGER(VECTOR_ELT(output_length, 8));
  ...
  SET_STRING_ELT(output_names, 6, mkChar("prop_wb"));
  SET_STRING_ELT(output_names, 7, mkChar("Ntotal"));
  SET_STRING_ELT(output_names, 8, mkChar("inf_1"));
  SET_VECTOR_ELT(ret, 1, output_length);
  UNPROTECT(2);
  SET_VECTOR_ELT(ret, 2, ScalarInteger(1 + internal->dim_FOI1 + internal->dim_R0t_1 + internal->dim_Delta + internal->dim_Kc + internal->dim_eip + internal->dim_prop_wb + internal->dim_Ntotal + internal->dim_inf_1));
  UNPROTECT(2);
  return ret;
}
SEXP odin_model_determ_initial_conditions(SEXP internal_p, SEXP step_ptr) {
...
SEXP odin_model_determ_rhs_r(SEXP internal_p, SEXP step, SEXP state) {
  ...
  odin_model_determ_internal *internal = odin_model_determ_get_internal(internal_p, 1);
  SEXP output_ptr = PROTECT(allocVector(REALSXP, 1 + internal->dim_FOI1 + internal->dim_R0t_1 + internal->dim_Delta + internal->dim_Kc + internal->dim_eip + internal->dim_prop_wb + internal->dim_Ntotal + internal->dim_inf_1));
