...
SEXP odin_model_determ_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->offset_output_Ntotal = 1 + internal->dim_FOI1 + internal->dim_R0t_1 + internal->dim_Delta + internal->dim_Kc + internal->dim_eip;
  ...
  internal->offset_output_inf_1 = 1 + internal->dim_FOI1 + internal->dim_R0t_1 + internal->dim_Delta + internal->dim_Kc + internal->dim_eip + internal->dim_Ntotal;
...
SEXP odin_model_determ_metadata(SEXP internal_p) {
  ...
  UNPROTECT(2);
  SET_VECTOR_ELT(ret, 2, ScalarInteger(1 + internal->dim_FOI1 + internal->dim_R0t_1 + internal->dim_Delta + internal->dim_Kc + internal->dim_eip + internal->dim_Ntotal + internal->dim_inf_1));
  UNPROTECT(2);
  return ret;
}
SEXP odin_model_determ_initial_conditions(SEXP internal_p, SEXP step_ptr) {
...
SEXP odin_model_determ_rhs_r(SEXP internal_p, SEXP step, SEXP state) {
  ...
  odin_model_determ_internal *internal = odin_model_determ_get_internal(internal_p, 1);
  SEXP output_ptr = PROTECT(allocVector(REALSXP, 1 + internal->dim_FOI1 + internal->dim_R0t_1 + internal->dim_Delta + internal->dim_Kc + internal->dim_eip + internal->dim_Ntotal + internal->dim_inf_1));
