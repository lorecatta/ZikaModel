...
SEXP odin_model_determ_set_initial(SEXP internal_p, SEXP step_ptr, SEXP state_ptr);
...
SEXP odin_model_stoch_set_initial(SEXP internal_p, SEXP step_ptr, SEXP state_ptr);
...
void odin_model_determ_finalise(SEXP internal_p) {
  ...
  if (internal_p) {
    R_Free(internal->age_I1);
    R_Free(internal->age_I1_prob);
    R_Free(internal->age_I1_trials);
    R_Free(internal->age_R1);
    R_Free(internal->age_R1_prob);
    R_Free(internal->age_S);
    R_Free(internal->age_S_prob);
    R_Free(internal->age_S_trials);
    R_Free(internal->agec);
    R_Free(internal->agert);
    R_Free(internal->amplitudes_phases);
    R_Free(internal->births);
    R_Free(internal->births_lambda);
    R_Free(internal->deathrt);
    R_Free(internal->Delta);
    R_Free(internal->Delta_wb);
    R_Free(internal->eip);
    R_Free(internal->FOI1);
    R_Free(internal->FOI1nn);
    R_Free(internal->FOI1p);
    R_Free(internal->inf_1);
    R_Free(internal->inf_1_prob);
    R_Free(internal->infectious1);
    R_Free(internal->init_I1);
    R_Free(internal->init_R1);
    R_Free(internal->init_S);
    R_Free(internal->initial_I1);
    R_Free(internal->initial_incubA);
    R_Free(internal->initial_incubB);
    R_Free(internal->initial_infectiousA);
    R_Free(internal->initial_infectiousB);
    R_Free(internal->initial_Lwb);
    R_Free(internal->initial_Lwt);
    R_Free(internal->initial_Mwb_E1);
    R_Free(internal->initial_Mwb_E2);
    R_Free(internal->initial_Mwb_I1);
    R_Free(internal->initial_Mwb_S);
    R_Free(internal->initial_Mwt_E1);
    R_Free(internal->initial_Mwt_E2);
    R_Free(internal->initial_Mwt_I1);
    R_Free(internal->initial_Mwt_S);
    R_Free(internal->initial_R1);
    R_Free(internal->initial_S);
    R_Free(internal->Kc);
    R_Free(internal->L_deathrt);
    R_Free(internal->L_dr);
    R_Free(internal->ln_pick);
    R_Free(internal->Lwb_birth);
    R_Free(internal->Lwb_birth_lambda);
    R_Free(internal->Lwb_mature);
    R_Free(internal->Lwb_mature_prob);
    R_Free(internal->Lwt_birth);
    R_Free(internal->Lwt_birth_lambda);
    R_Free(internal->Lwt_mature);
    R_Free(internal->Lwt_mature_prob);
    R_Free(internal->Mwb_E1_incub);
    R_Free(internal->Mwb_E1_incub_prob);
    R_Free(internal->Mwb_E2_incub);
    R_Free(internal->Mwb_E2_incub_prob);
    R_Free(internal->Mwb_FOI1);
    R_Free(internal->Mwb_inf1);
    R_Free(internal->Mwb_inf1_prob);
    R_Free(internal->Mwb_intro);
    R_Free(internal->Mwb_tot);
    R_Free(internal->Mwt);
    R_Free(internal->Mwt_E1_incub);
    R_Free(internal->Mwt_E1_incub_prob);
    R_Free(internal->Mwt_E2_incub);
    R_Free(internal->Mwt_E2_incub_prob);
    R_Free(internal->Mwt_FOI1);
    R_Free(internal->Mwt_inf1);
    R_Free(internal->Mwt_inf1_prob);
    R_Free(internal->Mwt_tot);
    R_Free(internal->N_eq);
    R_Free(internal->n_I1);
    R_Free(internal->n_R1);
    R_Free(internal->n_S);
    R_Free(internal->Nb);
    R_Free(internal->nn);
    R_Free(internal->Ntotal);
    R_Free(internal->Ntotal_sum);
    R_Free(internal->NTp);
    R_Free(internal->O_I1);
    R_Free(internal->O_I1_prob);
    R_Free(internal->O_Lwb);
    R_Free(internal->O_Lwb_prob);
    R_Free(internal->O_Lwt);
    R_Free(internal->O_Lwt_prob);
    R_Free(internal->O_Mwb_E1);
    R_Free(internal->O_Mwb_E1_prob);
    R_Free(internal->O_Mwb_E2);
    R_Free(internal->O_Mwb_E2_prob);
    R_Free(internal->O_Mwb_I1);
    R_Free(internal->O_Mwb_I1_prob);
    R_Free(internal->O_Mwb_S);
    R_Free(internal->O_Mwb_S_prob);
    R_Free(internal->O_Mwt_E1);
    R_Free(internal->O_Mwt_E1_prob);
    R_Free(internal->O_Mwt_E2);
    R_Free(internal->O_Mwt_E2_prob);
    R_Free(internal->O_Mwt_I1);
    R_Free(internal->O_Mwt_I1_prob);
    R_Free(internal->O_Mwt_S);
    R_Free(internal->O_Mwt_S_prob);
    R_Free(internal->O_R1);
    R_Free(internal->O_R1_prob);
    R_Free(internal->O_S);
    R_Free(internal->O_S_prob);
    R_Free(internal->phi1);
    R_Free(internal->R0t_1);
    R_Free(internal->recov1);
    R_Free(internal->recov1_prob);
    R_Free(internal->rho1);
    R_Free(internal->season_amp);
    R_Free(internal->season_phases);
    R_Free(internal->vacc_child_age);
    R_Free(internal->vacc_cu_age);
    R_Free(internal->vacc_noncov);
    R_Free(internal->vcu_noncov);
    R_Free(internal->Wb_introrate);
    R_Free(internal->Wb_introtime);
    R_Free(internal->Y1);
    R_Free(internal->Y1T);
    R_Free(internal->Y1T_sum);
    R_Free(internal);
    R_ClearExternalPtr(internal_p);
  }
}
SEXP odin_model_determ_create(SEXP user) {
  odin_model_determ_internal *internal = (odin_model_determ_internal*) R_Calloc(1, odin_model_determ_internal);
...
SEXP odin_model_determ_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 420));
  ...
  SET_VECTOR_ELT(contents, 64, ScalarInteger(internal->dim_I1));
  SET_VECTOR_ELT(contents, 65, ScalarInteger(internal->dim_I1_1));
  SET_VECTOR_ELT(contents, 66, ScalarInteger(internal->dim_I1_12));
  SET_VECTOR_ELT(contents, 67, ScalarInteger(internal->dim_I1_2));
  SET_VECTOR_ELT(contents, 68, ScalarInteger(internal->dim_I1_3));
  SET_VECTOR_ELT(contents, 69, ScalarInteger(internal->dim_incubA));
  SET_VECTOR_ELT(contents, 70, ScalarInteger(internal->dim_incubB));
  SET_VECTOR_ELT(contents, 71, ScalarInteger(internal->dim_inf_1));
  SET_VECTOR_ELT(contents, 72, ScalarInteger(internal->dim_inf_1_1));
  SET_VECTOR_ELT(contents, 73, ScalarInteger(internal->dim_inf_1_12));
  SET_VECTOR_ELT(contents, 74, ScalarInteger(internal->dim_inf_1_2));
  SET_VECTOR_ELT(contents, 75, ScalarInteger(internal->dim_inf_1_3));
  SET_VECTOR_ELT(contents, 76, ScalarInteger(internal->dim_inf_1_prob));
  SET_VECTOR_ELT(contents, 77, ScalarInteger(internal->dim_inf_1_prob_1));
  SET_VECTOR_ELT(contents, 78, ScalarInteger(internal->dim_inf_1_prob_12));
  SET_VECTOR_ELT(contents, 79, ScalarInteger(internal->dim_inf_1_prob_2));
  SET_VECTOR_ELT(contents, 80, ScalarInteger(internal->dim_inf_1_prob_3));
  SET_VECTOR_ELT(contents, 81, ScalarInteger(internal->dim_infectious1));
  SET_VECTOR_ELT(contents, 82, ScalarInteger(internal->dim_infectiousA));
  SET_VECTOR_ELT(contents, 83, ScalarInteger(internal->dim_infectiousB));
  SET_VECTOR_ELT(contents, 84, ScalarInteger(internal->dim_init_I1));
  SET_VECTOR_ELT(contents, 85, ScalarInteger(internal->dim_init_I1_1));
  SET_VECTOR_ELT(contents, 86, ScalarInteger(internal->dim_init_I1_12));
  SET_VECTOR_ELT(contents, 87, ScalarInteger(internal->dim_init_I1_2));
  SET_VECTOR_ELT(contents, 88, ScalarInteger(internal->dim_init_I1_3));
  SET_VECTOR_ELT(contents, 89, ScalarInteger(internal->dim_init_R1));
  SET_VECTOR_ELT(contents, 90, ScalarInteger(internal->dim_init_R1_1));
  SET_VECTOR_ELT(contents, 91, ScalarInteger(internal->dim_init_R1_12));
  SET_VECTOR_ELT(contents, 92, ScalarInteger(internal->dim_init_R1_2));
  SET_VECTOR_ELT(contents, 93, ScalarInteger(internal->dim_init_R1_3));
  SET_VECTOR_ELT(contents, 94, ScalarInteger(internal->dim_init_S));
  SET_VECTOR_ELT(contents, 95, ScalarInteger(internal->dim_init_S_1));
  SET_VECTOR_ELT(contents, 96, ScalarInteger(internal->dim_init_S_12));
  SET_VECTOR_ELT(contents, 97, ScalarInteger(internal->dim_init_S_2));
  SET_VECTOR_ELT(contents, 98, ScalarInteger(internal->dim_init_S_3));
  SET_VECTOR_ELT(contents, 99, ScalarInteger(internal->dim_Kc));
  SET_VECTOR_ELT(contents, 100, ScalarInteger(internal->dim_L_deathrt));
  SET_VECTOR_ELT(contents, 101, ScalarInteger(internal->dim_L_dr));
  SET_VECTOR_ELT(contents, 102, ScalarInteger(internal->dim_ln_pick));
  SET_VECTOR_ELT(contents, 103, ScalarInteger(internal->dim_Lwb));
  SET_VECTOR_ELT(contents, 104, ScalarInteger(internal->dim_Lwb_birth));
  SET_VECTOR_ELT(contents, 105, ScalarInteger(internal->dim_Lwb_birth_lambda));
  SET_VECTOR_ELT(contents, 106, ScalarInteger(internal->dim_Lwb_mature));
  SET_VECTOR_ELT(contents, 107, ScalarInteger(internal->dim_Lwb_mature_prob));
  SET_VECTOR_ELT(contents, 108, ScalarInteger(internal->dim_Lwt));
  SET_VECTOR_ELT(contents, 109, ScalarInteger(internal->dim_Lwt_birth));
  SET_VECTOR_ELT(contents, 110, ScalarInteger(internal->dim_Lwt_birth_lambda));
  SET_VECTOR_ELT(contents, 111, ScalarInteger(internal->dim_Lwt_mature));
  SET_VECTOR_ELT(contents, 112, ScalarInteger(internal->dim_Lwt_mature_prob));
  SET_VECTOR_ELT(contents, 113, ScalarInteger(internal->dim_Mwb_E1));
  SET_VECTOR_ELT(contents, 114, ScalarInteger(internal->dim_Mwb_E1_incub));
  SET_VECTOR_ELT(contents, 115, ScalarInteger(internal->dim_Mwb_E1_incub_prob));
  SET_VECTOR_ELT(contents, 116, ScalarInteger(internal->dim_Mwb_E2));
  SET_VECTOR_ELT(contents, 117, ScalarInteger(internal->dim_Mwb_E2_incub));
  SET_VECTOR_ELT(contents, 118, ScalarInteger(internal->dim_Mwb_E2_incub_prob));
  SET_VECTOR_ELT(contents, 119, ScalarInteger(internal->dim_Mwb_FOI1));
  SET_VECTOR_ELT(contents, 120, ScalarInteger(internal->dim_Mwb_I1));
  SET_VECTOR_ELT(contents, 121, ScalarInteger(internal->dim_Mwb_inf1));
  SET_VECTOR_ELT(contents, 122, ScalarInteger(internal->dim_Mwb_inf1_prob));
  SET_VECTOR_ELT(contents, 123, ScalarInteger(internal->dim_Mwb_intro));
  SET_VECTOR_ELT(contents, 124, ScalarInteger(internal->dim_Mwb_S));
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->dim_Mwb_tot));
  SET_VECTOR_ELT(contents, 126, ScalarInteger(internal->dim_Mwt));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->dim_Mwt_E1));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->dim_Mwt_E1_incub));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->dim_Mwt_E1_incub_prob));
  SET_VECTOR_ELT(contents, 130, ScalarInteger(internal->dim_Mwt_E2));
  SET_VECTOR_ELT(contents, 131, ScalarInteger(internal->dim_Mwt_E2_incub));
  SET_VECTOR_ELT(contents, 132, ScalarInteger(internal->dim_Mwt_E2_incub_prob));
  SET_VECTOR_ELT(contents, 133, ScalarInteger(internal->dim_Mwt_FOI1));
  SET_VECTOR_ELT(contents, 134, ScalarInteger(internal->dim_Mwt_I1));
  SET_VECTOR_ELT(contents, 135, ScalarInteger(internal->dim_Mwt_inf1));
  SET_VECTOR_ELT(contents, 136, ScalarInteger(internal->dim_Mwt_inf1_prob));
  SET_VECTOR_ELT(contents, 137, ScalarInteger(internal->dim_Mwt_S));
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->dim_Mwt_tot));
  SET_VECTOR_ELT(contents, 139, ScalarInteger(internal->dim_N_eq));
  SET_VECTOR_ELT(contents, 140, ScalarInteger(internal->dim_n_I1));
  SET_VECTOR_ELT(contents, 141, ScalarInteger(internal->dim_n_I1_1));
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->dim_n_I1_12));
  SET_VECTOR_ELT(contents, 143, ScalarInteger(internal->dim_n_I1_2));
  SET_VECTOR_ELT(contents, 144, ScalarInteger(internal->dim_n_I1_3));
  SET_VECTOR_ELT(contents, 145, ScalarInteger(internal->dim_n_R1));
  SET_VECTOR_ELT(contents, 146, ScalarInteger(internal->dim_n_R1_1));
  SET_VECTOR_ELT(contents, 147, ScalarInteger(internal->dim_n_R1_12));
  SET_VECTOR_ELT(contents, 148, ScalarInteger(internal->dim_n_R1_2));
  SET_VECTOR_ELT(contents, 149, ScalarInteger(internal->dim_n_R1_3));
  SET_VECTOR_ELT(contents, 150, ScalarInteger(internal->dim_n_S));
  SET_VECTOR_ELT(contents, 151, ScalarInteger(internal->dim_n_S_1));
  SET_VECTOR_ELT(contents, 152, ScalarInteger(internal->dim_n_S_12));
  SET_VECTOR_ELT(contents, 153, ScalarInteger(internal->dim_n_S_2));
  SET_VECTOR_ELT(contents, 154, ScalarInteger(internal->dim_n_S_3));
  SET_VECTOR_ELT(contents, 155, ScalarInteger(internal->dim_Nb));
  SET_VECTOR_ELT(contents, 156, ScalarInteger(internal->dim_nn));
  SET_VECTOR_ELT(contents, 157, ScalarInteger(internal->dim_nn_1));
  SET_VECTOR_ELT(contents, 158, ScalarInteger(internal->dim_nn_2));
  SET_VECTOR_ELT(contents, 159, ScalarInteger(internal->dim_Ntotal));
  SET_VECTOR_ELT(contents, 160, ScalarInteger(internal->dim_Ntotal_1));
  SET_VECTOR_ELT(contents, 161, ScalarInteger(internal->dim_Ntotal_12));
  SET_VECTOR_ELT(contents, 162, ScalarInteger(internal->dim_Ntotal_2));
  SET_VECTOR_ELT(contents, 163, ScalarInteger(internal->dim_Ntotal_3));
  SET_VECTOR_ELT(contents, 164, ScalarInteger(internal->dim_Ntotal_sum));
  SET_VECTOR_ELT(contents, 165, ScalarInteger(internal->dim_Ntotal_sum_1));
  SET_VECTOR_ELT(contents, 166, ScalarInteger(internal->dim_Ntotal_sum_2));
  SET_VECTOR_ELT(contents, 167, ScalarInteger(internal->dim_NTp));
  SET_VECTOR_ELT(contents, 168, ScalarInteger(internal->dim_O_I1));
  SET_VECTOR_ELT(contents, 169, ScalarInteger(internal->dim_O_I1_1));
  SET_VECTOR_ELT(contents, 170, ScalarInteger(internal->dim_O_I1_12));
  SET_VECTOR_ELT(contents, 171, ScalarInteger(internal->dim_O_I1_2));
  SET_VECTOR_ELT(contents, 172, ScalarInteger(internal->dim_O_I1_3));
  SET_VECTOR_ELT(contents, 173, ScalarInteger(internal->dim_O_I1_prob));
  SET_VECTOR_ELT(contents, 174, ScalarInteger(internal->dim_O_Lwb));
  SET_VECTOR_ELT(contents, 175, ScalarInteger(internal->dim_O_Lwb_prob));
  SET_VECTOR_ELT(contents, 176, ScalarInteger(internal->dim_O_Lwt));
  SET_VECTOR_ELT(contents, 177, ScalarInteger(internal->dim_O_Lwt_prob));
  SET_VECTOR_ELT(contents, 178, ScalarInteger(internal->dim_O_Mwb_E1));
  SET_VECTOR_ELT(contents, 179, ScalarInteger(internal->dim_O_Mwb_E1_prob));
  SET_VECTOR_ELT(contents, 180, ScalarInteger(internal->dim_O_Mwb_E2));
  SET_VECTOR_ELT(contents, 181, ScalarInteger(internal->dim_O_Mwb_E2_prob));
  SET_VECTOR_ELT(contents, 182, ScalarInteger(internal->dim_O_Mwb_I1));
  SET_VECTOR_ELT(contents, 183, ScalarInteger(internal->dim_O_Mwb_I1_prob));
  SET_VECTOR_ELT(contents, 184, ScalarInteger(internal->dim_O_Mwb_S));
  SET_VECTOR_ELT(contents, 185, ScalarInteger(internal->dim_O_Mwb_S_prob));
  SET_VECTOR_ELT(contents, 186, ScalarInteger(internal->dim_O_Mwt_E1));
  SET_VECTOR_ELT(contents, 187, ScalarInteger(internal->dim_O_Mwt_E1_prob));
  SET_VECTOR_ELT(contents, 188, ScalarInteger(internal->dim_O_Mwt_E2));
  SET_VECTOR_ELT(contents, 189, ScalarInteger(internal->dim_O_Mwt_E2_prob));
  SET_VECTOR_ELT(contents, 190, ScalarInteger(internal->dim_O_Mwt_I1));
  SET_VECTOR_ELT(contents, 191, ScalarInteger(internal->dim_O_Mwt_I1_prob));
  SET_VECTOR_ELT(contents, 192, ScalarInteger(internal->dim_O_Mwt_S));
  SET_VECTOR_ELT(contents, 193, ScalarInteger(internal->dim_O_Mwt_S_prob));
  SET_VECTOR_ELT(contents, 194, ScalarInteger(internal->dim_O_R1));
  SET_VECTOR_ELT(contents, 195, ScalarInteger(internal->dim_O_R1_1));
  SET_VECTOR_ELT(contents, 196, ScalarInteger(internal->dim_O_R1_12));
  SET_VECTOR_ELT(contents, 197, ScalarInteger(internal->dim_O_R1_2));
  SET_VECTOR_ELT(contents, 198, ScalarInteger(internal->dim_O_R1_3));
  SET_VECTOR_ELT(contents, 199, ScalarInteger(internal->dim_O_R1_prob));
  SET_VECTOR_ELT(contents, 200, ScalarInteger(internal->dim_O_S));
  SET_VECTOR_ELT(contents, 201, ScalarInteger(internal->dim_O_S_1));
  SET_VECTOR_ELT(contents, 202, ScalarInteger(internal->dim_O_S_12));
  SET_VECTOR_ELT(contents, 203, ScalarInteger(internal->dim_O_S_2));
  SET_VECTOR_ELT(contents, 204, ScalarInteger(internal->dim_O_S_3));
  SET_VECTOR_ELT(contents, 205, ScalarInteger(internal->dim_O_S_prob));
  SET_VECTOR_ELT(contents, 206, ScalarInteger(internal->dim_O_S_prob_1));
  SET_VECTOR_ELT(contents, 207, ScalarInteger(internal->dim_O_S_prob_12));
  SET_VECTOR_ELT(contents, 208, ScalarInteger(internal->dim_O_S_prob_2));
  SET_VECTOR_ELT(contents, 209, ScalarInteger(internal->dim_O_S_prob_3));
  SET_VECTOR_ELT(contents, 210, ScalarInteger(internal->dim_phi1));
  SET_VECTOR_ELT(contents, 211, ScalarInteger(internal->dim_R0t_1));
  SET_VECTOR_ELT(contents, 212, ScalarInteger(internal->dim_R1));
  SET_VECTOR_ELT(contents, 213, ScalarInteger(internal->dim_R1_1));
  SET_VECTOR_ELT(contents, 214, ScalarInteger(internal->dim_R1_12));
  SET_VECTOR_ELT(contents, 215, ScalarInteger(internal->dim_R1_2));
  SET_VECTOR_ELT(contents, 216, ScalarInteger(internal->dim_R1_3));
  SET_VECTOR_ELT(contents, 217, ScalarInteger(internal->dim_recov1));
  SET_VECTOR_ELT(contents, 218, ScalarInteger(internal->dim_recov1_1));
  SET_VECTOR_ELT(contents, 219, ScalarInteger(internal->dim_recov1_12));
  SET_VECTOR_ELT(contents, 220, ScalarInteger(internal->dim_recov1_2));
  SET_VECTOR_ELT(contents, 221, ScalarInteger(internal->dim_recov1_3));
  SET_VECTOR_ELT(contents, 222, ScalarInteger(internal->dim_recov1_prob));
  SET_VECTOR_ELT(contents, 223, ScalarInteger(internal->dim_rho1));
  SET_VECTOR_ELT(contents, 224, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 225, ScalarInteger(internal->dim_S_1));
  SET_VECTOR_ELT(contents, 226, ScalarInteger(internal->dim_S_12));
  SET_VECTOR_ELT(contents, 227, ScalarInteger(internal->dim_S_2));
  SET_VECTOR_ELT(contents, 228, ScalarInteger(internal->dim_S_3));
  SET_VECTOR_ELT(contents, 229, ScalarInteger(internal->dim_season_amp));
  SET_VECTOR_ELT(contents, 230, ScalarInteger(internal->dim_season_phases));
  SET_VECTOR_ELT(contents, 231, ScalarInteger(internal->dim_vacc_child_age));
  SET_VECTOR_ELT(contents, 232, ScalarInteger(internal->dim_vacc_cu_age));
  SET_VECTOR_ELT(contents, 233, ScalarInteger(internal->dim_vacc_noncov));
  SET_VECTOR_ELT(contents, 234, ScalarInteger(internal->dim_vacc_noncov_1));
  SET_VECTOR_ELT(contents, 235, ScalarInteger(internal->dim_vacc_noncov_2));
  SET_VECTOR_ELT(contents, 236, ScalarInteger(internal->dim_vcu_noncov));
  SET_VECTOR_ELT(contents, 237, ScalarInteger(internal->dim_vcu_noncov_1));
  SET_VECTOR_ELT(contents, 238, ScalarInteger(internal->dim_vcu_noncov_2));
  SET_VECTOR_ELT(contents, 239, ScalarInteger(internal->dim_Wb_introrate));
  SET_VECTOR_ELT(contents, 240, ScalarInteger(internal->dim_Wb_introtime));
  SET_VECTOR_ELT(contents, 241, ScalarInteger(internal->dim_Y1));
  SET_VECTOR_ELT(contents, 242, ScalarInteger(internal->dim_Y1_1));
  SET_VECTOR_ELT(contents, 243, ScalarInteger(internal->dim_Y1_12));
  SET_VECTOR_ELT(contents, 244, ScalarInteger(internal->dim_Y1_2));
  SET_VECTOR_ELT(contents, 245, ScalarInteger(internal->dim_Y1_3));
  SET_VECTOR_ELT(contents, 246, ScalarInteger(internal->dim_Y1T));
  SET_VECTOR_ELT(contents, 247, ScalarInteger(internal->dim_Y1T_sum));
  SET_VECTOR_ELT(contents, 248, ScalarInteger(internal->dim_Y1T_sum_1));
  SET_VECTOR_ELT(contents, 249, ScalarInteger(internal->dim_Y1T_sum_2));
  SET_VECTOR_ELT(contents, 250, ScalarReal(internal->DT));
  SEXP eip = PROTECT(allocVector(REALSXP, internal->dim_eip));
  memcpy(REAL(eip), internal->eip, internal->dim_eip * sizeof(double));
  SET_VECTOR_ELT(contents, 251, eip);
  SET_VECTOR_ELT(contents, 252, ScalarReal(internal->eip_mean));
  SET_VECTOR_ELT(contents, 253, ScalarReal(internal->eip_season));
  SET_VECTOR_ELT(contents, 254, ScalarReal(internal->Epsilon));
  SEXP FOI1 = PROTECT(allocVector(REALSXP, internal->dim_FOI1));
  memcpy(REAL(FOI1), internal->FOI1, internal->dim_FOI1 * sizeof(double));
  SET_VECTOR_ELT(contents, 255, FOI1);
  ...
  SET_VECTOR_ELT(contents, 256, FOI1nn);
  ...
  SET_VECTOR_ELT(contents, 257, FOI1p);
  SET_VECTOR_ELT(contents, 258, ScalarReal(internal->Gamma));
  SET_VECTOR_ELT(contents, 259, ScalarReal(internal->incub));
  ...
  SET_VECTOR_ELT(contents, 260, inf_1);
  ...
  SET_VECTOR_ELT(contents, 261, inf_1_prob);
  SET_VECTOR_ELT(contents, 262, ScalarReal(internal->inf_per));
  ...
  SET_VECTOR_ELT(contents, 263, infectious1);
  ...
  SET_VECTOR_ELT(contents, 264, init_I1);
  ...
  SET_VECTOR_ELT(contents, 265, init_R1);
  ...
  SET_VECTOR_ELT(contents, 266, init_S);
  ...
  SET_VECTOR_ELT(contents, 267, initial_I1);
  ...
  SET_VECTOR_ELT(contents, 268, initial_incubA);
  ...
  SET_VECTOR_ELT(contents, 269, initial_incubB);
  ...
  SET_VECTOR_ELT(contents, 270, initial_infectiousA);
  ...
  SET_VECTOR_ELT(contents, 271, initial_infectiousB);
  ...
  SET_VECTOR_ELT(contents, 272, initial_Lwb);
  ...
  SET_VECTOR_ELT(contents, 273, initial_Lwt);
  ...
  SET_VECTOR_ELT(contents, 274, initial_Mwb_E1);
  ...
  SET_VECTOR_ELT(contents, 275, initial_Mwb_E2);
  ...
  SET_VECTOR_ELT(contents, 276, initial_Mwb_I1);
  ...
  SET_VECTOR_ELT(contents, 277, initial_Mwb_S);
  ...
  SET_VECTOR_ELT(contents, 278, initial_Mwt_E1);
  ...
  SET_VECTOR_ELT(contents, 279, initial_Mwt_E2);
  ...
  SET_VECTOR_ELT(contents, 280, initial_Mwt_I1);
  ...
  SET_VECTOR_ELT(contents, 281, initial_Mwt_S);
  ...
  SET_VECTOR_ELT(contents, 282, initial_R1);
  ...
  SET_VECTOR_ELT(contents, 283, initial_S);
  SET_VECTOR_ELT(contents, 284, ScalarReal(internal->Kappa));
  SEXP Kc = PROTECT(allocVector(REALSXP, internal->dim_Kc));
  memcpy(REAL(Kc), internal->Kc, internal->dim_Kc * sizeof(double));
  SET_VECTOR_ELT(contents, 285, Kc);
  SET_VECTOR_ELT(contents, 286, ScalarReal(internal->Kc_mean));
  SET_VECTOR_ELT(contents, 287, ScalarReal(internal->Kc_season));
  ...
  SET_VECTOR_ELT(contents, 288, L_deathrt);
  SEXP L_dr = PROTECT(allocVector(REALSXP, internal->dim_L_dr));
  memcpy(REAL(L_dr), internal->L_dr, internal->dim_L_dr * sizeof(double));
  SET_VECTOR_ELT(contents, 289, L_dr);
  SET_VECTOR_ELT(contents, 290, ScalarReal(internal->ln_mean));
  ...
  SET_VECTOR_ELT(contents, 291, ln_pick);
  SET_VECTOR_ELT(contents, 292, ScalarReal(internal->ln_sd));
  ...
  SET_VECTOR_ELT(contents, 293, Lwb_birth);
  ...
  SET_VECTOR_ELT(contents, 294, Lwb_birth_lambda);
  ...
  SET_VECTOR_ELT(contents, 295, Lwb_mature);
  ...
  SET_VECTOR_ELT(contents, 296, Lwb_mature_prob);
  ...
  SET_VECTOR_ELT(contents, 297, Lwt_birth);
  ...
  SET_VECTOR_ELT(contents, 298, Lwt_birth_lambda);
  ...
  SET_VECTOR_ELT(contents, 299, Lwt_mature);
  ...
  SET_VECTOR_ELT(contents, 300, Lwt_mature_prob);
  ...
  SET_VECTOR_ELT(contents, 301, Mwb_E1_incub);
  ...
  SET_VECTOR_ELT(contents, 302, Mwb_E1_incub_prob);
  ...
  SET_VECTOR_ELT(contents, 303, Mwb_E2_incub);
  ...
  SET_VECTOR_ELT(contents, 304, Mwb_E2_incub_prob);
  ...
  SET_VECTOR_ELT(contents, 305, Mwb_FOI1);
  ...
  SET_VECTOR_ELT(contents, 306, Mwb_inf1);
  ...
  SET_VECTOR_ELT(contents, 307, Mwb_inf1_prob);
  ...
  SET_VECTOR_ELT(contents, 308, Mwb_intro);
  ...
  SET_VECTOR_ELT(contents, 309, Mwb_tot);
  SEXP Mwt = PROTECT(allocVector(REALSXP, internal->dim_Mwt));
  memcpy(REAL(Mwt), internal->Mwt, internal->dim_Mwt * sizeof(double));
  SET_VECTOR_ELT(contents, 310, Mwt);
  SET_VECTOR_ELT(contents, 311, ScalarReal(internal->Mwt_cv));
  ...
  SET_VECTOR_ELT(contents, 312, Mwt_E1_incub);
  ...
  SET_VECTOR_ELT(contents, 313, Mwt_E1_incub_prob);
  ...
  SET_VECTOR_ELT(contents, 314, Mwt_E2_incub);
  ...
  SET_VECTOR_ELT(contents, 315, Mwt_E2_incub_prob);
  ...
  SET_VECTOR_ELT(contents, 316, Mwt_FOI1);
  ...
  SET_VECTOR_ELT(contents, 317, Mwt_inf1);
  ...
  SET_VECTOR_ELT(contents, 318, Mwt_inf1_prob);
  SET_VECTOR_ELT(contents, 319, ScalarReal(internal->Mwt_mean));
  ...
  SET_VECTOR_ELT(contents, 322, n_I1);
  ...
  SET_VECTOR_ELT(contents, 323, n_R1);
  ...
  SET_VECTOR_ELT(contents, 324, n_S);
  SET_VECTOR_ELT(contents, 325, ScalarInteger(internal->na));
  SEXP Nb = PROTECT(allocVector(REALSXP, internal->dim_Nb));
  memcpy(REAL(Nb), internal->Nb, internal->dim_Nb * sizeof(double));
  SET_VECTOR_ELT(contents, 326, Nb);
  ...
  SET_VECTOR_ELT(contents, 327, nn);
  SET_VECTOR_ELT(contents, 328, ScalarInteger(internal->NP));
  ...
  SET_VECTOR_ELT(contents, 329, Ntotal);
  ...
  SET_VECTOR_ELT(contents, 330, Ntotal_sum);
  SEXP NTp = PROTECT(allocVector(REALSXP, internal->dim_NTp));
  memcpy(REAL(NTp), internal->NTp, internal->dim_NTp * sizeof(double));
  SET_VECTOR_ELT(contents, 331, NTp);
  SET_VECTOR_ELT(contents, 332, ScalarReal(internal->nu));
  ...
  SET_VECTOR_ELT(contents, 333, O_I1);
  ...
  SET_VECTOR_ELT(contents, 334, O_I1_prob);
  ...
  SET_VECTOR_ELT(contents, 335, O_Lwb);
  ...
  SET_VECTOR_ELT(contents, 336, O_Lwb_prob);
  ...
  SET_VECTOR_ELT(contents, 337, O_Lwt);
  ...
  SET_VECTOR_ELT(contents, 338, O_Lwt_prob);
  ...
  SET_VECTOR_ELT(contents, 339, O_Mwb_E1);
  ...
  SET_VECTOR_ELT(contents, 340, O_Mwb_E1_prob);
  ...
  SET_VECTOR_ELT(contents, 341, O_Mwb_E2);
  ...
  SET_VECTOR_ELT(contents, 342, O_Mwb_E2_prob);
  ...
  SET_VECTOR_ELT(contents, 343, O_Mwb_I1);
  ...
  SET_VECTOR_ELT(contents, 344, O_Mwb_I1_prob);
  ...
  SET_VECTOR_ELT(contents, 345, O_Mwb_S);
  ...
  SET_VECTOR_ELT(contents, 346, O_Mwb_S_prob);
  ...
  SET_VECTOR_ELT(contents, 347, O_Mwt_E1);
  ...
  SET_VECTOR_ELT(contents, 348, O_Mwt_E1_prob);
  ...
  SET_VECTOR_ELT(contents, 349, O_Mwt_E2);
  ...
  SET_VECTOR_ELT(contents, 350, O_Mwt_E2_prob);
  ...
  SET_VECTOR_ELT(contents, 351, O_Mwt_I1);
  ...
  SET_VECTOR_ELT(contents, 352, O_Mwt_I1_prob);
  ...
  SET_VECTOR_ELT(contents, 353, O_Mwt_S);
  ...
  SET_VECTOR_ELT(contents, 354, O_Mwt_S_prob);
  ...
  SET_VECTOR_ELT(contents, 355, O_R1);
  ...
  SET_VECTOR_ELT(contents, 356, O_R1_prob);
  ...
  SET_VECTOR_ELT(contents, 357, O_S);
  ...
  SET_VECTOR_ELT(contents, 358, O_S_prob);
  SET_VECTOR_ELT(contents, 359, ScalarInteger(internal->offset_output_Delta));
  SET_VECTOR_ELT(contents, 360, ScalarInteger(internal->offset_output_eip));
  SET_VECTOR_ELT(contents, 361, ScalarInteger(internal->offset_output_inf_1));
  SET_VECTOR_ELT(contents, 362, ScalarInteger(internal->offset_output_Kc));
  SET_VECTOR_ELT(contents, 363, ScalarInteger(internal->offset_output_Ntotal));
  SET_VECTOR_ELT(contents, 364, ScalarInteger(internal->offset_output_R0t_1));
  SET_VECTOR_ELT(contents, 365, ScalarInteger(internal->offset_variable_I1));
  SET_VECTOR_ELT(contents, 366, ScalarInteger(internal->offset_variable_incubA));
  SET_VECTOR_ELT(contents, 367, ScalarInteger(internal->offset_variable_incubB));
  SET_VECTOR_ELT(contents, 368, ScalarInteger(internal->offset_variable_infectiousA));
  SET_VECTOR_ELT(contents, 369, ScalarInteger(internal->offset_variable_infectiousB));
  SET_VECTOR_ELT(contents, 370, ScalarInteger(internal->offset_variable_Lwb));
  SET_VECTOR_ELT(contents, 371, ScalarInteger(internal->offset_variable_Mwb_E1));
  SET_VECTOR_ELT(contents, 372, ScalarInteger(internal->offset_variable_Mwb_E2));
  SET_VECTOR_ELT(contents, 373, ScalarInteger(internal->offset_variable_Mwb_I1));
  SET_VECTOR_ELT(contents, 374, ScalarInteger(internal->offset_variable_Mwb_S));
  SET_VECTOR_ELT(contents, 375, ScalarInteger(internal->offset_variable_Mwt_E1));
  SET_VECTOR_ELT(contents, 376, ScalarInteger(internal->offset_variable_Mwt_E2));
  SET_VECTOR_ELT(contents, 377, ScalarInteger(internal->offset_variable_Mwt_I1));
  SET_VECTOR_ELT(contents, 378, ScalarInteger(internal->offset_variable_R1));
  SET_VECTOR_ELT(contents, 379, ScalarInteger(internal->offset_variable_S));
  SET_VECTOR_ELT(contents, 380, ScalarReal(internal->Omega));
  SEXP phi1 = PROTECT(allocVector(REALSXP, internal->dim_phi1));
  memcpy(REAL(phi1), internal->phi1, internal->dim_phi1 * sizeof(double));
  SET_VECTOR_ELT(contents, 381, phi1);
  SET_VECTOR_ELT(contents, 382, ScalarReal(internal->pi));
  SET_VECTOR_ELT(contents, 383, ScalarReal(internal->propMwtControl));
  SET_VECTOR_ELT(contents, 384, ScalarReal(internal->propTransGlobal));
  SET_VECTOR_ELT(contents, 385, ScalarReal(internal->propTransNN));
  ...
  SET_VECTOR_ELT(contents, 386, R0t_1);
  ...
  SET_VECTOR_ELT(contents, 387, recov1);
  ...
  SET_VECTOR_ELT(contents, 388, recov1_prob);
  SEXP rho1 = PROTECT(allocVector(REALSXP, internal->dim_rho1));
  memcpy(REAL(rho1), internal->rho1, internal->dim_rho1 * sizeof(double));
  SET_VECTOR_ELT(contents, 389, rho1);
  SET_VECTOR_ELT(contents, 390, ScalarReal(internal->Rm));
  ...
  SET_VECTOR_ELT(contents, 391, season_amp);
  ...
  SET_VECTOR_ELT(contents, 392, season_phases);
  SET_VECTOR_ELT(contents, 393, ScalarReal(internal->Sigma));
  SET_VECTOR_ELT(contents, 394, ScalarReal(internal->TimeMwtControlOff));
  SET_VECTOR_ELT(contents, 395, ScalarReal(internal->TimeMwtControlOn));
  ...
  SET_VECTOR_ELT(contents, 396, vacc_child_age);
  SET_VECTOR_ELT(contents, 397, ScalarReal(internal->vacc_child_coverage));
  SET_VECTOR_ELT(contents, 398, ScalarReal(internal->vacc_child_starttime));
  SET_VECTOR_ELT(contents, 399, ScalarReal(internal->vacc_child_stoptime));
  ...
  SET_VECTOR_ELT(contents, 400, vacc_cu_age);
  SET_VECTOR_ELT(contents, 401, ScalarReal(internal->vacc_cu_coverage));
  SET_VECTOR_ELT(contents, 402, ScalarReal(internal->vacc_cu_rndtime));
  ...
  SET_VECTOR_ELT(contents, 403, vacc_noncov);
  ...
  SET_VECTOR_ELT(contents, 404, vcu_noncov);
  SET_VECTOR_ELT(contents, 405, ScalarInteger(internal->vnc_row));
  SET_VECTOR_ELT(contents, 406, ScalarReal(internal->Wb_cyto));
  SET_VECTOR_ELT(contents, 407, ScalarReal(internal->Wb_fF));
  SET_VECTOR_ELT(contents, 408, ScalarReal(internal->Wb_fM));
  SET_VECTOR_ELT(contents, 409, ScalarReal(internal->Wb_introduration));
  SET_VECTOR_ELT(contents, 410, ScalarReal(internal->Wb_introlevel));
  ...
  SET_VECTOR_ELT(contents, 411, Wb_introrate);
  ...
  SET_VECTOR_ELT(contents, 412, Wb_introtime);
  SET_VECTOR_ELT(contents, 413, ScalarReal(internal->Wb_mat));
  SET_VECTOR_ELT(contents, 414, ScalarReal(internal->Wb_relinf1));
  SET_VECTOR_ELT(contents, 415, ScalarReal(internal->Wb_relsusc1));
  ...
  SET_VECTOR_ELT(contents, 418, Y1T_sum);
  SET_VECTOR_ELT(contents, 419, ScalarReal(internal->YL));
  SEXP nms = PROTECT(allocVector(STRSXP, 420));
  ...
  SET_STRING_ELT(nms, 64, mkChar("dim_I1"));
  SET_STRING_ELT(nms, 65, mkChar("dim_I1_1"));
  SET_STRING_ELT(nms, 66, mkChar("dim_I1_12"));
  SET_STRING_ELT(nms, 67, mkChar("dim_I1_2"));
  SET_STRING_ELT(nms, 68, mkChar("dim_I1_3"));
  SET_STRING_ELT(nms, 69, mkChar("dim_incubA"));
  SET_STRING_ELT(nms, 70, mkChar("dim_incubB"));
  SET_STRING_ELT(nms, 71, mkChar("dim_inf_1"));
  SET_STRING_ELT(nms, 72, mkChar("dim_inf_1_1"));
  SET_STRING_ELT(nms, 73, mkChar("dim_inf_1_12"));
  SET_STRING_ELT(nms, 74, mkChar("dim_inf_1_2"));
  SET_STRING_ELT(nms, 75, mkChar("dim_inf_1_3"));
  SET_STRING_ELT(nms, 76, mkChar("dim_inf_1_prob"));
  SET_STRING_ELT(nms, 77, mkChar("dim_inf_1_prob_1"));
  SET_STRING_ELT(nms, 78, mkChar("dim_inf_1_prob_12"));
  SET_STRING_ELT(nms, 79, mkChar("dim_inf_1_prob_2"));
  SET_STRING_ELT(nms, 80, mkChar("dim_inf_1_prob_3"));
  SET_STRING_ELT(nms, 81, mkChar("dim_infectious1"));
  SET_STRING_ELT(nms, 82, mkChar("dim_infectiousA"));
  SET_STRING_ELT(nms, 83, mkChar("dim_infectiousB"));
  SET_STRING_ELT(nms, 84, mkChar("dim_init_I1"));
  SET_STRING_ELT(nms, 85, mkChar("dim_init_I1_1"));
  SET_STRING_ELT(nms, 86, mkChar("dim_init_I1_12"));
  SET_STRING_ELT(nms, 87, mkChar("dim_init_I1_2"));
  SET_STRING_ELT(nms, 88, mkChar("dim_init_I1_3"));
  SET_STRING_ELT(nms, 89, mkChar("dim_init_R1"));
  SET_STRING_ELT(nms, 90, mkChar("dim_init_R1_1"));
  SET_STRING_ELT(nms, 91, mkChar("dim_init_R1_12"));
  SET_STRING_ELT(nms, 92, mkChar("dim_init_R1_2"));
  SET_STRING_ELT(nms, 93, mkChar("dim_init_R1_3"));
  SET_STRING_ELT(nms, 94, mkChar("dim_init_S"));
  SET_STRING_ELT(nms, 95, mkChar("dim_init_S_1"));
  SET_STRING_ELT(nms, 96, mkChar("dim_init_S_12"));
  SET_STRING_ELT(nms, 97, mkChar("dim_init_S_2"));
  SET_STRING_ELT(nms, 98, mkChar("dim_init_S_3"));
  SET_STRING_ELT(nms, 99, mkChar("dim_Kc"));
  SET_STRING_ELT(nms, 100, mkChar("dim_L_deathrt"));
  SET_STRING_ELT(nms, 101, mkChar("dim_L_dr"));
  SET_STRING_ELT(nms, 102, mkChar("dim_ln_pick"));
  SET_STRING_ELT(nms, 103, mkChar("dim_Lwb"));
  SET_STRING_ELT(nms, 104, mkChar("dim_Lwb_birth"));
  SET_STRING_ELT(nms, 105, mkChar("dim_Lwb_birth_lambda"));
  SET_STRING_ELT(nms, 106, mkChar("dim_Lwb_mature"));
  SET_STRING_ELT(nms, 107, mkChar("dim_Lwb_mature_prob"));
  SET_STRING_ELT(nms, 108, mkChar("dim_Lwt"));
  SET_STRING_ELT(nms, 109, mkChar("dim_Lwt_birth"));
  SET_STRING_ELT(nms, 110, mkChar("dim_Lwt_birth_lambda"));
  SET_STRING_ELT(nms, 111, mkChar("dim_Lwt_mature"));
  SET_STRING_ELT(nms, 112, mkChar("dim_Lwt_mature_prob"));
  SET_STRING_ELT(nms, 113, mkChar("dim_Mwb_E1"));
  SET_STRING_ELT(nms, 114, mkChar("dim_Mwb_E1_incub"));
  SET_STRING_ELT(nms, 115, mkChar("dim_Mwb_E1_incub_prob"));
  SET_STRING_ELT(nms, 116, mkChar("dim_Mwb_E2"));
  SET_STRING_ELT(nms, 117, mkChar("dim_Mwb_E2_incub"));
  SET_STRING_ELT(nms, 118, mkChar("dim_Mwb_E2_incub_prob"));
  SET_STRING_ELT(nms, 119, mkChar("dim_Mwb_FOI1"));
  SET_STRING_ELT(nms, 120, mkChar("dim_Mwb_I1"));
  SET_STRING_ELT(nms, 121, mkChar("dim_Mwb_inf1"));
  SET_STRING_ELT(nms, 122, mkChar("dim_Mwb_inf1_prob"));
  SET_STRING_ELT(nms, 123, mkChar("dim_Mwb_intro"));
  SET_STRING_ELT(nms, 124, mkChar("dim_Mwb_S"));
  SET_STRING_ELT(nms, 125, mkChar("dim_Mwb_tot"));
  SET_STRING_ELT(nms, 126, mkChar("dim_Mwt"));
  SET_STRING_ELT(nms, 127, mkChar("dim_Mwt_E1"));
  SET_STRING_ELT(nms, 128, mkChar("dim_Mwt_E1_incub"));
  SET_STRING_ELT(nms, 129, mkChar("dim_Mwt_E1_incub_prob"));
  SET_STRING_ELT(nms, 130, mkChar("dim_Mwt_E2"));
  SET_STRING_ELT(nms, 131, mkChar("dim_Mwt_E2_incub"));
  SET_STRING_ELT(nms, 132, mkChar("dim_Mwt_E2_incub_prob"));
  SET_STRING_ELT(nms, 133, mkChar("dim_Mwt_FOI1"));
  SET_STRING_ELT(nms, 134, mkChar("dim_Mwt_I1"));
  SET_STRING_ELT(nms, 135, mkChar("dim_Mwt_inf1"));
  SET_STRING_ELT(nms, 136, mkChar("dim_Mwt_inf1_prob"));
  SET_STRING_ELT(nms, 137, mkChar("dim_Mwt_S"));
  SET_STRING_ELT(nms, 138, mkChar("dim_Mwt_tot"));
  SET_STRING_ELT(nms, 139, mkChar("dim_N_eq"));
  SET_STRING_ELT(nms, 140, mkChar("dim_n_I1"));
  SET_STRING_ELT(nms, 141, mkChar("dim_n_I1_1"));
  SET_STRING_ELT(nms, 142, mkChar("dim_n_I1_12"));
  SET_STRING_ELT(nms, 143, mkChar("dim_n_I1_2"));
  SET_STRING_ELT(nms, 144, mkChar("dim_n_I1_3"));
  SET_STRING_ELT(nms, 145, mkChar("dim_n_R1"));
  SET_STRING_ELT(nms, 146, mkChar("dim_n_R1_1"));
  SET_STRING_ELT(nms, 147, mkChar("dim_n_R1_12"));
  SET_STRING_ELT(nms, 148, mkChar("dim_n_R1_2"));
  SET_STRING_ELT(nms, 149, mkChar("dim_n_R1_3"));
  SET_STRING_ELT(nms, 150, mkChar("dim_n_S"));
  SET_STRING_ELT(nms, 151, mkChar("dim_n_S_1"));
  SET_STRING_ELT(nms, 152, mkChar("dim_n_S_12"));
  SET_STRING_ELT(nms, 153, mkChar("dim_n_S_2"));
  SET_STRING_ELT(nms, 154, mkChar("dim_n_S_3"));
  SET_STRING_ELT(nms, 155, mkChar("dim_Nb"));
  SET_STRING_ELT(nms, 156, mkChar("dim_nn"));
  SET_STRING_ELT(nms, 157, mkChar("dim_nn_1"));
  SET_STRING_ELT(nms, 158, mkChar("dim_nn_2"));
  SET_STRING_ELT(nms, 159, mkChar("dim_Ntotal"));
  SET_STRING_ELT(nms, 160, mkChar("dim_Ntotal_1"));
  SET_STRING_ELT(nms, 161, mkChar("dim_Ntotal_12"));
  SET_STRING_ELT(nms, 162, mkChar("dim_Ntotal_2"));
  SET_STRING_ELT(nms, 163, mkChar("dim_Ntotal_3"));
  SET_STRING_ELT(nms, 164, mkChar("dim_Ntotal_sum"));
  SET_STRING_ELT(nms, 165, mkChar("dim_Ntotal_sum_1"));
  SET_STRING_ELT(nms, 166, mkChar("dim_Ntotal_sum_2"));
  SET_STRING_ELT(nms, 167, mkChar("dim_NTp"));
  SET_STRING_ELT(nms, 168, mkChar("dim_O_I1"));
  SET_STRING_ELT(nms, 169, mkChar("dim_O_I1_1"));
  SET_STRING_ELT(nms, 170, mkChar("dim_O_I1_12"));
  SET_STRING_ELT(nms, 171, mkChar("dim_O_I1_2"));
  SET_STRING_ELT(nms, 172, mkChar("dim_O_I1_3"));
  SET_STRING_ELT(nms, 173, mkChar("dim_O_I1_prob"));
  SET_STRING_ELT(nms, 174, mkChar("dim_O_Lwb"));
  SET_STRING_ELT(nms, 175, mkChar("dim_O_Lwb_prob"));
  SET_STRING_ELT(nms, 176, mkChar("dim_O_Lwt"));
  SET_STRING_ELT(nms, 177, mkChar("dim_O_Lwt_prob"));
  SET_STRING_ELT(nms, 178, mkChar("dim_O_Mwb_E1"));
  SET_STRING_ELT(nms, 179, mkChar("dim_O_Mwb_E1_prob"));
  SET_STRING_ELT(nms, 180, mkChar("dim_O_Mwb_E2"));
  SET_STRING_ELT(nms, 181, mkChar("dim_O_Mwb_E2_prob"));
  SET_STRING_ELT(nms, 182, mkChar("dim_O_Mwb_I1"));
  SET_STRING_ELT(nms, 183, mkChar("dim_O_Mwb_I1_prob"));
  SET_STRING_ELT(nms, 184, mkChar("dim_O_Mwb_S"));
  SET_STRING_ELT(nms, 185, mkChar("dim_O_Mwb_S_prob"));
  SET_STRING_ELT(nms, 186, mkChar("dim_O_Mwt_E1"));
  SET_STRING_ELT(nms, 187, mkChar("dim_O_Mwt_E1_prob"));
  SET_STRING_ELT(nms, 188, mkChar("dim_O_Mwt_E2"));
  SET_STRING_ELT(nms, 189, mkChar("dim_O_Mwt_E2_prob"));
  SET_STRING_ELT(nms, 190, mkChar("dim_O_Mwt_I1"));
  SET_STRING_ELT(nms, 191, mkChar("dim_O_Mwt_I1_prob"));
  SET_STRING_ELT(nms, 192, mkChar("dim_O_Mwt_S"));
  SET_STRING_ELT(nms, 193, mkChar("dim_O_Mwt_S_prob"));
  SET_STRING_ELT(nms, 194, mkChar("dim_O_R1"));
  SET_STRING_ELT(nms, 195, mkChar("dim_O_R1_1"));
  SET_STRING_ELT(nms, 196, mkChar("dim_O_R1_12"));
  SET_STRING_ELT(nms, 197, mkChar("dim_O_R1_2"));
  SET_STRING_ELT(nms, 198, mkChar("dim_O_R1_3"));
  SET_STRING_ELT(nms, 199, mkChar("dim_O_R1_prob"));
  SET_STRING_ELT(nms, 200, mkChar("dim_O_S"));
  SET_STRING_ELT(nms, 201, mkChar("dim_O_S_1"));
  SET_STRING_ELT(nms, 202, mkChar("dim_O_S_12"));
  SET_STRING_ELT(nms, 203, mkChar("dim_O_S_2"));
  SET_STRING_ELT(nms, 204, mkChar("dim_O_S_3"));
  SET_STRING_ELT(nms, 205, mkChar("dim_O_S_prob"));
  SET_STRING_ELT(nms, 206, mkChar("dim_O_S_prob_1"));
  SET_STRING_ELT(nms, 207, mkChar("dim_O_S_prob_12"));
  SET_STRING_ELT(nms, 208, mkChar("dim_O_S_prob_2"));
  SET_STRING_ELT(nms, 209, mkChar("dim_O_S_prob_3"));
  SET_STRING_ELT(nms, 210, mkChar("dim_phi1"));
  SET_STRING_ELT(nms, 211, mkChar("dim_R0t_1"));
  SET_STRING_ELT(nms, 212, mkChar("dim_R1"));
  SET_STRING_ELT(nms, 213, mkChar("dim_R1_1"));
  SET_STRING_ELT(nms, 214, mkChar("dim_R1_12"));
  SET_STRING_ELT(nms, 215, mkChar("dim_R1_2"));
  SET_STRING_ELT(nms, 216, mkChar("dim_R1_3"));
  SET_STRING_ELT(nms, 217, mkChar("dim_recov1"));
  SET_STRING_ELT(nms, 218, mkChar("dim_recov1_1"));
  SET_STRING_ELT(nms, 219, mkChar("dim_recov1_12"));
  SET_STRING_ELT(nms, 220, mkChar("dim_recov1_2"));
  SET_STRING_ELT(nms, 221, mkChar("dim_recov1_3"));
  SET_STRING_ELT(nms, 222, mkChar("dim_recov1_prob"));
  SET_STRING_ELT(nms, 223, mkChar("dim_rho1"));
  SET_STRING_ELT(nms, 224, mkChar("dim_S"));
  SET_STRING_ELT(nms, 225, mkChar("dim_S_1"));
  SET_STRING_ELT(nms, 226, mkChar("dim_S_12"));
  SET_STRING_ELT(nms, 227, mkChar("dim_S_2"));
  SET_STRING_ELT(nms, 228, mkChar("dim_S_3"));
  SET_STRING_ELT(nms, 229, mkChar("dim_season_amp"));
  SET_STRING_ELT(nms, 230, mkChar("dim_season_phases"));
  SET_STRING_ELT(nms, 231, mkChar("dim_vacc_child_age"));
  SET_STRING_ELT(nms, 232, mkChar("dim_vacc_cu_age"));
  SET_STRING_ELT(nms, 233, mkChar("dim_vacc_noncov"));
  SET_STRING_ELT(nms, 234, mkChar("dim_vacc_noncov_1"));
  SET_STRING_ELT(nms, 235, mkChar("dim_vacc_noncov_2"));
  SET_STRING_ELT(nms, 236, mkChar("dim_vcu_noncov"));
  SET_STRING_ELT(nms, 237, mkChar("dim_vcu_noncov_1"));
  SET_STRING_ELT(nms, 238, mkChar("dim_vcu_noncov_2"));
  SET_STRING_ELT(nms, 239, mkChar("dim_Wb_introrate"));
  SET_STRING_ELT(nms, 240, mkChar("dim_Wb_introtime"));
  SET_STRING_ELT(nms, 241, mkChar("dim_Y1"));
  SET_STRING_ELT(nms, 242, mkChar("dim_Y1_1"));
  SET_STRING_ELT(nms, 243, mkChar("dim_Y1_12"));
  SET_STRING_ELT(nms, 244, mkChar("dim_Y1_2"));
  SET_STRING_ELT(nms, 245, mkChar("dim_Y1_3"));
  SET_STRING_ELT(nms, 246, mkChar("dim_Y1T"));
  SET_STRING_ELT(nms, 247, mkChar("dim_Y1T_sum"));
  SET_STRING_ELT(nms, 248, mkChar("dim_Y1T_sum_1"));
  SET_STRING_ELT(nms, 249, mkChar("dim_Y1T_sum_2"));
  SET_STRING_ELT(nms, 250, mkChar("DT"));
  SET_STRING_ELT(nms, 251, mkChar("eip"));
  SET_STRING_ELT(nms, 252, mkChar("eip_mean"));
  SET_STRING_ELT(nms, 253, mkChar("eip_season"));
  SET_STRING_ELT(nms, 254, mkChar("Epsilon"));
  SET_STRING_ELT(nms, 255, mkChar("FOI1"));
  SET_STRING_ELT(nms, 256, mkChar("FOI1nn"));
  SET_STRING_ELT(nms, 257, mkChar("FOI1p"));
  SET_STRING_ELT(nms, 258, mkChar("Gamma"));
  SET_STRING_ELT(nms, 259, mkChar("incub"));
  SET_STRING_ELT(nms, 260, mkChar("inf_1"));
  SET_STRING_ELT(nms, 261, mkChar("inf_1_prob"));
  SET_STRING_ELT(nms, 262, mkChar("inf_per"));
  SET_STRING_ELT(nms, 263, mkChar("infectious1"));
  SET_STRING_ELT(nms, 264, mkChar("init_I1"));
  SET_STRING_ELT(nms, 265, mkChar("init_R1"));
  SET_STRING_ELT(nms, 266, mkChar("init_S"));
  SET_STRING_ELT(nms, 267, mkChar("initial_I1"));
  SET_STRING_ELT(nms, 268, mkChar("initial_incubA"));
  SET_STRING_ELT(nms, 269, mkChar("initial_incubB"));
  SET_STRING_ELT(nms, 270, mkChar("initial_infectiousA"));
  SET_STRING_ELT(nms, 271, mkChar("initial_infectiousB"));
  SET_STRING_ELT(nms, 272, mkChar("initial_Lwb"));
  SET_STRING_ELT(nms, 273, mkChar("initial_Lwt"));
  SET_STRING_ELT(nms, 274, mkChar("initial_Mwb_E1"));
  SET_STRING_ELT(nms, 275, mkChar("initial_Mwb_E2"));
  SET_STRING_ELT(nms, 276, mkChar("initial_Mwb_I1"));
  SET_STRING_ELT(nms, 277, mkChar("initial_Mwb_S"));
  SET_STRING_ELT(nms, 278, mkChar("initial_Mwt_E1"));
  SET_STRING_ELT(nms, 279, mkChar("initial_Mwt_E2"));
  SET_STRING_ELT(nms, 280, mkChar("initial_Mwt_I1"));
  SET_STRING_ELT(nms, 281, mkChar("initial_Mwt_S"));
  SET_STRING_ELT(nms, 282, mkChar("initial_R1"));
  SET_STRING_ELT(nms, 283, mkChar("initial_S"));
  SET_STRING_ELT(nms, 284, mkChar("Kappa"));
  SET_STRING_ELT(nms, 285, mkChar("Kc"));
  SET_STRING_ELT(nms, 286, mkChar("Kc_mean"));
  SET_STRING_ELT(nms, 287, mkChar("Kc_season"));
  SET_STRING_ELT(nms, 288, mkChar("L_deathrt"));
  SET_STRING_ELT(nms, 289, mkChar("L_dr"));
  SET_STRING_ELT(nms, 290, mkChar("ln_mean"));
  SET_STRING_ELT(nms, 291, mkChar("ln_pick"));
  SET_STRING_ELT(nms, 292, mkChar("ln_sd"));
  SET_STRING_ELT(nms, 293, mkChar("Lwb_birth"));
  SET_STRING_ELT(nms, 294, mkChar("Lwb_birth_lambda"));
  SET_STRING_ELT(nms, 295, mkChar("Lwb_mature"));
  SET_STRING_ELT(nms, 296, mkChar("Lwb_mature_prob"));
  SET_STRING_ELT(nms, 297, mkChar("Lwt_birth"));
  SET_STRING_ELT(nms, 298, mkChar("Lwt_birth_lambda"));
  SET_STRING_ELT(nms, 299, mkChar("Lwt_mature"));
  SET_STRING_ELT(nms, 300, mkChar("Lwt_mature_prob"));
  SET_STRING_ELT(nms, 301, mkChar("Mwb_E1_incub"));
  SET_STRING_ELT(nms, 302, mkChar("Mwb_E1_incub_prob"));
  SET_STRING_ELT(nms, 303, mkChar("Mwb_E2_incub"));
  SET_STRING_ELT(nms, 304, mkChar("Mwb_E2_incub_prob"));
  SET_STRING_ELT(nms, 305, mkChar("Mwb_FOI1"));
  SET_STRING_ELT(nms, 306, mkChar("Mwb_inf1"));
  SET_STRING_ELT(nms, 307, mkChar("Mwb_inf1_prob"));
  SET_STRING_ELT(nms, 308, mkChar("Mwb_intro"));
  SET_STRING_ELT(nms, 309, mkChar("Mwb_tot"));
  SET_STRING_ELT(nms, 310, mkChar("Mwt"));
  SET_STRING_ELT(nms, 311, mkChar("Mwt_cv"));
  SET_STRING_ELT(nms, 312, mkChar("Mwt_E1_incub"));
  SET_STRING_ELT(nms, 313, mkChar("Mwt_E1_incub_prob"));
  SET_STRING_ELT(nms, 314, mkChar("Mwt_E2_incub"));
  SET_STRING_ELT(nms, 315, mkChar("Mwt_E2_incub_prob"));
  SET_STRING_ELT(nms, 316, mkChar("Mwt_FOI1"));
  SET_STRING_ELT(nms, 317, mkChar("Mwt_inf1"));
  SET_STRING_ELT(nms, 318, mkChar("Mwt_inf1_prob"));
  SET_STRING_ELT(nms, 319, mkChar("Mwt_mean"));
  SET_STRING_ELT(nms, 320, mkChar("Mwt_tot"));
  SET_STRING_ELT(nms, 321, mkChar("N_eq"));
  SET_STRING_ELT(nms, 322, mkChar("n_I1"));
  SET_STRING_ELT(nms, 323, mkChar("n_R1"));
  SET_STRING_ELT(nms, 324, mkChar("n_S"));
  SET_STRING_ELT(nms, 325, mkChar("na"));
  SET_STRING_ELT(nms, 326, mkChar("Nb"));
  SET_STRING_ELT(nms, 327, mkChar("nn"));
  SET_STRING_ELT(nms, 328, mkChar("NP"));
  SET_STRING_ELT(nms, 329, mkChar("Ntotal"));
  SET_STRING_ELT(nms, 330, mkChar("Ntotal_sum"));
  SET_STRING_ELT(nms, 331, mkChar("NTp"));
  SET_STRING_ELT(nms, 332, mkChar("nu"));
  SET_STRING_ELT(nms, 333, mkChar("O_I1"));
  SET_STRING_ELT(nms, 334, mkChar("O_I1_prob"));
  SET_STRING_ELT(nms, 335, mkChar("O_Lwb"));
  SET_STRING_ELT(nms, 336, mkChar("O_Lwb_prob"));
  SET_STRING_ELT(nms, 337, mkChar("O_Lwt"));
  SET_STRING_ELT(nms, 338, mkChar("O_Lwt_prob"));
  SET_STRING_ELT(nms, 339, mkChar("O_Mwb_E1"));
  SET_STRING_ELT(nms, 340, mkChar("O_Mwb_E1_prob"));
  SET_STRING_ELT(nms, 341, mkChar("O_Mwb_E2"));
  SET_STRING_ELT(nms, 342, mkChar("O_Mwb_E2_prob"));
  SET_STRING_ELT(nms, 343, mkChar("O_Mwb_I1"));
  SET_STRING_ELT(nms, 344, mkChar("O_Mwb_I1_prob"));
  SET_STRING_ELT(nms, 345, mkChar("O_Mwb_S"));
  SET_STRING_ELT(nms, 346, mkChar("O_Mwb_S_prob"));
  SET_STRING_ELT(nms, 347, mkChar("O_Mwt_E1"));
  SET_STRING_ELT(nms, 348, mkChar("O_Mwt_E1_prob"));
  SET_STRING_ELT(nms, 349, mkChar("O_Mwt_E2"));
  SET_STRING_ELT(nms, 350, mkChar("O_Mwt_E2_prob"));
  SET_STRING_ELT(nms, 351, mkChar("O_Mwt_I1"));
  SET_STRING_ELT(nms, 352, mkChar("O_Mwt_I1_prob"));
  SET_STRING_ELT(nms, 353, mkChar("O_Mwt_S"));
  SET_STRING_ELT(nms, 354, mkChar("O_Mwt_S_prob"));
  SET_STRING_ELT(nms, 355, mkChar("O_R1"));
  SET_STRING_ELT(nms, 356, mkChar("O_R1_prob"));
  SET_STRING_ELT(nms, 357, mkChar("O_S"));
  SET_STRING_ELT(nms, 358, mkChar("O_S_prob"));
  SET_STRING_ELT(nms, 359, mkChar("offset_output_Delta"));
  SET_STRING_ELT(nms, 360, mkChar("offset_output_eip"));
  SET_STRING_ELT(nms, 361, mkChar("offset_output_inf_1"));
  SET_STRING_ELT(nms, 362, mkChar("offset_output_Kc"));
  SET_STRING_ELT(nms, 363, mkChar("offset_output_Ntotal"));
  SET_STRING_ELT(nms, 364, mkChar("offset_output_R0t_1"));
  SET_STRING_ELT(nms, 365, mkChar("offset_variable_I1"));
  SET_STRING_ELT(nms, 366, mkChar("offset_variable_incubA"));
  SET_STRING_ELT(nms, 367, mkChar("offset_variable_incubB"));
  SET_STRING_ELT(nms, 368, mkChar("offset_variable_infectiousA"));
  SET_STRING_ELT(nms, 369, mkChar("offset_variable_infectiousB"));
  SET_STRING_ELT(nms, 370, mkChar("offset_variable_Lwb"));
  SET_STRING_ELT(nms, 371, mkChar("offset_variable_Mwb_E1"));
  SET_STRING_ELT(nms, 372, mkChar("offset_variable_Mwb_E2"));
  SET_STRING_ELT(nms, 373, mkChar("offset_variable_Mwb_I1"));
  SET_STRING_ELT(nms, 374, mkChar("offset_variable_Mwb_S"));
  SET_STRING_ELT(nms, 375, mkChar("offset_variable_Mwt_E1"));
  SET_STRING_ELT(nms, 376, mkChar("offset_variable_Mwt_E2"));
  SET_STRING_ELT(nms, 377, mkChar("offset_variable_Mwt_I1"));
  SET_STRING_ELT(nms, 378, mkChar("offset_variable_R1"));
  SET_STRING_ELT(nms, 379, mkChar("offset_variable_S"));
  SET_STRING_ELT(nms, 380, mkChar("Omega"));
  SET_STRING_ELT(nms, 381, mkChar("phi1"));
  SET_STRING_ELT(nms, 382, mkChar("pi"));
  SET_STRING_ELT(nms, 383, mkChar("propMwtControl"));
  SET_STRING_ELT(nms, 384, mkChar("propTransGlobal"));
  SET_STRING_ELT(nms, 385, mkChar("propTransNN"));
  SET_STRING_ELT(nms, 386, mkChar("R0t_1"));
  SET_STRING_ELT(nms, 387, mkChar("recov1"));
  SET_STRING_ELT(nms, 388, mkChar("recov1_prob"));
  SET_STRING_ELT(nms, 389, mkChar("rho1"));
  SET_STRING_ELT(nms, 390, mkChar("Rm"));
  SET_STRING_ELT(nms, 391, mkChar("season_amp"));
  SET_STRING_ELT(nms, 392, mkChar("season_phases"));
  SET_STRING_ELT(nms, 393, mkChar("Sigma"));
  SET_STRING_ELT(nms, 394, mkChar("TimeMwtControlOff"));
  SET_STRING_ELT(nms, 395, mkChar("TimeMwtControlOn"));
  SET_STRING_ELT(nms, 396, mkChar("vacc_child_age"));
  SET_STRING_ELT(nms, 397, mkChar("vacc_child_coverage"));
  SET_STRING_ELT(nms, 398, mkChar("vacc_child_starttime"));
  SET_STRING_ELT(nms, 399, mkChar("vacc_child_stoptime"));
  SET_STRING_ELT(nms, 400, mkChar("vacc_cu_age"));
  SET_STRING_ELT(nms, 401, mkChar("vacc_cu_coverage"));
  SET_STRING_ELT(nms, 402, mkChar("vacc_cu_rndtime"));
  SET_STRING_ELT(nms, 403, mkChar("vacc_noncov"));
  SET_STRING_ELT(nms, 404, mkChar("vcu_noncov"));
  SET_STRING_ELT(nms, 405, mkChar("vnc_row"));
  SET_STRING_ELT(nms, 406, mkChar("Wb_cyto"));
  SET_STRING_ELT(nms, 407, mkChar("Wb_fF"));
  SET_STRING_ELT(nms, 408, mkChar("Wb_fM"));
  SET_STRING_ELT(nms, 409, mkChar("Wb_introduration"));
  SET_STRING_ELT(nms, 410, mkChar("Wb_introlevel"));
  SET_STRING_ELT(nms, 411, mkChar("Wb_introrate"));
  SET_STRING_ELT(nms, 412, mkChar("Wb_introtime"));
  SET_STRING_ELT(nms, 413, mkChar("Wb_mat"));
  SET_STRING_ELT(nms, 414, mkChar("Wb_relinf1"));
  SET_STRING_ELT(nms, 415, mkChar("Wb_relsusc1"));
  SET_STRING_ELT(nms, 416, mkChar("Y1"));
  SET_STRING_ELT(nms, 417, mkChar("Y1T"));
  SET_STRING_ELT(nms, 418, mkChar("Y1T_sum"));
  SET_STRING_ELT(nms, 419, mkChar("YL"));
...
SEXP odin_model_determ_set_user(SEXP internal_p, SEXP user) {
  ...
  R_Free(internal->age_I1_prob);
  internal->age_I1_prob = (double*) R_Calloc(internal->dim_age_I1_prob, double);
  R_Free(internal->age_R1_prob);
  internal->age_R1_prob = (double*) R_Calloc(internal->dim_age_R1_prob, double);
  R_Free(internal->age_S_prob);
  internal->age_S_prob = (double*) R_Calloc(internal->dim_age_S_prob, double);
  R_Free(internal->agert);
  internal->agert = (double*) R_Calloc(internal->dim_agert, double);
  R_Free(internal->births);
  internal->births = (double*) R_Calloc(internal->dim_births, double);
  R_Free(internal->births_lambda);
  internal->births_lambda = (double*) R_Calloc(internal->dim_births_lambda, double);
  R_Free(internal->Delta);
  internal->Delta = (double*) R_Calloc(internal->dim_Delta, double);
  R_Free(internal->Delta_wb);
  internal->Delta_wb = (double*) R_Calloc(internal->dim_Delta_wb, double);
  R_Free(internal->eip);
  internal->eip = (double*) R_Calloc(internal->dim_eip, double);
  R_Free(internal->FOI1);
  internal->FOI1 = (double*) R_Calloc(internal->dim_FOI1, double);
  R_Free(internal->FOI1nn);
  internal->FOI1nn = (double*) R_Calloc(internal->dim_FOI1nn, double);
  R_Free(internal->FOI1p);
  internal->FOI1p = (double*) R_Calloc(internal->dim_FOI1p, double);
  R_Free(internal->infectious1);
  internal->infectious1 = (double*) R_Calloc(internal->dim_infectious1, double);
  R_Free(internal->initial_incubA);
  internal->initial_incubA = (double*) R_Calloc(internal->dim_incubA, double);
  R_Free(internal->initial_incubB);
  internal->initial_incubB = (double*) R_Calloc(internal->dim_incubB, double);
  R_Free(internal->initial_infectiousA);
  internal->initial_infectiousA = (double*) R_Calloc(internal->dim_infectiousA, double);
  R_Free(internal->initial_infectiousB);
  internal->initial_infectiousB = (double*) R_Calloc(internal->dim_infectiousB, double);
  R_Free(internal->initial_Lwb);
  internal->initial_Lwb = (double*) R_Calloc(internal->dim_Lwb, double);
  R_Free(internal->initial_Lwt);
  internal->initial_Lwt = (double*) R_Calloc(internal->dim_Lwt, double);
  R_Free(internal->initial_Mwb_E1);
  internal->initial_Mwb_E1 = (double*) R_Calloc(internal->dim_Mwb_E1, double);
  R_Free(internal->initial_Mwb_E2);
  internal->initial_Mwb_E2 = (double*) R_Calloc(internal->dim_Mwb_E2, double);
  R_Free(internal->initial_Mwb_I1);
  internal->initial_Mwb_I1 = (double*) R_Calloc(internal->dim_Mwb_I1, double);
  R_Free(internal->initial_Mwb_S);
  internal->initial_Mwb_S = (double*) R_Calloc(internal->dim_Mwb_S, double);
  R_Free(internal->initial_Mwt_E1);
  internal->initial_Mwt_E1 = (double*) R_Calloc(internal->dim_Mwt_E1, double);
  R_Free(internal->initial_Mwt_E2);
  internal->initial_Mwt_E2 = (double*) R_Calloc(internal->dim_Mwt_E2, double);
  R_Free(internal->initial_Mwt_I1);
  internal->initial_Mwt_I1 = (double*) R_Calloc(internal->dim_Mwt_I1, double);
  R_Free(internal->initial_Mwt_S);
  internal->initial_Mwt_S = (double*) R_Calloc(internal->dim_Mwt_S, double);
  R_Free(internal->Kc);
  internal->Kc = (double*) R_Calloc(internal->dim_Kc, double);
  R_Free(internal->L_deathrt);
  internal->L_deathrt = (double*) R_Calloc(internal->dim_L_deathrt, double);
  R_Free(internal->L_dr);
  internal->L_dr = (double*) R_Calloc(internal->dim_L_dr, double);
  R_Free(internal->ln_pick);
  internal->ln_pick = (double*) R_Calloc(internal->dim_ln_pick, double);
  R_Free(internal->Lwb_birth);
  internal->Lwb_birth = (double*) R_Calloc(internal->dim_Lwb_birth, double);
  R_Free(internal->Lwb_birth_lambda);
  internal->Lwb_birth_lambda = (double*) R_Calloc(internal->dim_Lwb_birth_lambda, double);
  R_Free(internal->Lwb_mature);
  internal->Lwb_mature = (double*) R_Calloc(internal->dim_Lwb_mature, double);
  R_Free(internal->Lwb_mature_prob);
  internal->Lwb_mature_prob = (double*) R_Calloc(internal->dim_Lwb_mature_prob, double);
  R_Free(internal->Lwt_birth);
  internal->Lwt_birth = (double*) R_Calloc(internal->dim_Lwt_birth, double);
  R_Free(internal->Lwt_birth_lambda);
  internal->Lwt_birth_lambda = (double*) R_Calloc(internal->dim_Lwt_birth_lambda, double);
  R_Free(internal->Lwt_mature);
  internal->Lwt_mature = (double*) R_Calloc(internal->dim_Lwt_mature, double);
  R_Free(internal->Lwt_mature_prob);
  internal->Lwt_mature_prob = (double*) R_Calloc(internal->dim_Lwt_mature_prob, double);
  R_Free(internal->Mwb_E1_incub);
  internal->Mwb_E1_incub = (double*) R_Calloc(internal->dim_Mwb_E1_incub, double);
  R_Free(internal->Mwb_E1_incub_prob);
  internal->Mwb_E1_incub_prob = (double*) R_Calloc(internal->dim_Mwb_E1_incub_prob, double);
  R_Free(internal->Mwb_E2_incub);
  internal->Mwb_E2_incub = (double*) R_Calloc(internal->dim_Mwb_E2_incub, double);
  R_Free(internal->Mwb_E2_incub_prob);
  internal->Mwb_E2_incub_prob = (double*) R_Calloc(internal->dim_Mwb_E2_incub_prob, double);
  R_Free(internal->Mwb_FOI1);
  internal->Mwb_FOI1 = (double*) R_Calloc(internal->dim_Mwb_FOI1, double);
  R_Free(internal->Mwb_inf1);
  internal->Mwb_inf1 = (double*) R_Calloc(internal->dim_Mwb_inf1, double);
  R_Free(internal->Mwb_inf1_prob);
  internal->Mwb_inf1_prob = (double*) R_Calloc(internal->dim_Mwb_inf1_prob, double);
  R_Free(internal->Mwb_intro);
  internal->Mwb_intro = (double*) R_Calloc(internal->dim_Mwb_intro, double);
  R_Free(internal->Mwb_tot);
  internal->Mwb_tot = (double*) R_Calloc(internal->dim_Mwb_tot, double);
  R_Free(internal->Mwt);
  internal->Mwt = (double*) R_Calloc(internal->dim_Mwt, double);
  R_Free(internal->Mwt_E1_incub);
  internal->Mwt_E1_incub = (double*) R_Calloc(internal->dim_Mwt_E1_incub, double);
  R_Free(internal->Mwt_E1_incub_prob);
  internal->Mwt_E1_incub_prob = (double*) R_Calloc(internal->dim_Mwt_E1_incub_prob, double);
  R_Free(internal->Mwt_E2_incub);
  internal->Mwt_E2_incub = (double*) R_Calloc(internal->dim_Mwt_E2_incub, double);
  R_Free(internal->Mwt_E2_incub_prob);
  internal->Mwt_E2_incub_prob = (double*) R_Calloc(internal->dim_Mwt_E2_incub_prob, double);
  R_Free(internal->Mwt_FOI1);
  internal->Mwt_FOI1 = (double*) R_Calloc(internal->dim_Mwt_FOI1, double);
  R_Free(internal->Mwt_inf1);
  internal->Mwt_inf1 = (double*) R_Calloc(internal->dim_Mwt_inf1, double);
  R_Free(internal->Mwt_inf1_prob);
  internal->Mwt_inf1_prob = (double*) R_Calloc(internal->dim_Mwt_inf1_prob, double);
  R_Free(internal->Mwt_tot);
  internal->Mwt_tot = (double*) R_Calloc(internal->dim_Mwt_tot, double);
  R_Free(internal->NTp);
  internal->NTp = (double*) R_Calloc(internal->dim_NTp, double);
  R_Free(internal->O_I1_prob);
  internal->O_I1_prob = (double*) R_Calloc(internal->dim_O_I1_prob, double);
  R_Free(internal->O_Lwb);
  internal->O_Lwb = (double*) R_Calloc(internal->dim_O_Lwb, double);
  R_Free(internal->O_Lwb_prob);
  internal->O_Lwb_prob = (double*) R_Calloc(internal->dim_O_Lwb_prob, double);
  R_Free(internal->O_Lwt);
  internal->O_Lwt = (double*) R_Calloc(internal->dim_O_Lwt, double);
  R_Free(internal->O_Lwt_prob);
  internal->O_Lwt_prob = (double*) R_Calloc(internal->dim_O_Lwt_prob, double);
  R_Free(internal->O_Mwb_E1);
  internal->O_Mwb_E1 = (double*) R_Calloc(internal->dim_O_Mwb_E1, double);
  R_Free(internal->O_Mwb_E1_prob);
  internal->O_Mwb_E1_prob = (double*) R_Calloc(internal->dim_O_Mwb_E1_prob, double);
  R_Free(internal->O_Mwb_E2);
  internal->O_Mwb_E2 = (double*) R_Calloc(internal->dim_O_Mwb_E2, double);
  R_Free(internal->O_Mwb_E2_prob);
  internal->O_Mwb_E2_prob = (double*) R_Calloc(internal->dim_O_Mwb_E2_prob, double);
  R_Free(internal->O_Mwb_I1);
  internal->O_Mwb_I1 = (double*) R_Calloc(internal->dim_O_Mwb_I1, double);
  R_Free(internal->O_Mwb_I1_prob);
  internal->O_Mwb_I1_prob = (double*) R_Calloc(internal->dim_O_Mwb_I1_prob, double);
  R_Free(internal->O_Mwb_S);
  internal->O_Mwb_S = (double*) R_Calloc(internal->dim_O_Mwb_S, double);
  R_Free(internal->O_Mwb_S_prob);
  internal->O_Mwb_S_prob = (double*) R_Calloc(internal->dim_O_Mwb_S_prob, double);
  R_Free(internal->O_Mwt_E1);
  internal->O_Mwt_E1 = (double*) R_Calloc(internal->dim_O_Mwt_E1, double);
  R_Free(internal->O_Mwt_E1_prob);
  internal->O_Mwt_E1_prob = (double*) R_Calloc(internal->dim_O_Mwt_E1_prob, double);
  R_Free(internal->O_Mwt_E2);
  internal->O_Mwt_E2 = (double*) R_Calloc(internal->dim_O_Mwt_E2, double);
  R_Free(internal->O_Mwt_E2_prob);
  internal->O_Mwt_E2_prob = (double*) R_Calloc(internal->dim_O_Mwt_E2_prob, double);
  R_Free(internal->O_Mwt_I1);
  internal->O_Mwt_I1 = (double*) R_Calloc(internal->dim_O_Mwt_I1, double);
  R_Free(internal->O_Mwt_I1_prob);
  internal->O_Mwt_I1_prob = (double*) R_Calloc(internal->dim_O_Mwt_I1_prob, double);
  R_Free(internal->O_Mwt_S);
  internal->O_Mwt_S = (double*) R_Calloc(internal->dim_O_Mwt_S, double);
  R_Free(internal->O_Mwt_S_prob);
  internal->O_Mwt_S_prob = (double*) R_Calloc(internal->dim_O_Mwt_S_prob, double);
  R_Free(internal->O_R1_prob);
  internal->O_R1_prob = (double*) R_Calloc(internal->dim_O_R1_prob, double);
  R_Free(internal->R0t_1);
  internal->R0t_1 = (double*) R_Calloc(internal->dim_R0t_1, double);
  R_Free(internal->recov1_prob);
  internal->recov1_prob = (double*) R_Calloc(internal->dim_recov1_prob, double);
  R_Free(internal->season_amp);
  internal->season_amp = (double*) R_Calloc(internal->dim_season_amp, double);
  R_Free(internal->season_phases);
  internal->season_phases = (double*) R_Calloc(internal->dim_season_phases, double);
  R_Free(internal->Wb_introrate);
  internal->Wb_introrate = (double*) R_Calloc(internal->dim_Wb_introrate, double);
  R_Free(internal->Y1T);
  internal->Y1T = (double*) R_Calloc(internal->dim_Y1T, double);
  ...
  internal->offset_output_Delta = internal->dim_FOI1 + internal->dim_R0t_1 + 1;
  internal->offset_output_eip = internal->dim_Delta + internal->dim_FOI1 + internal->dim_Kc + internal->dim_R0t_1 + 1;
  internal->offset_output_Kc = internal->dim_Delta + internal->dim_FOI1 + internal->dim_R0t_1 + 1;
  internal->offset_output_Ntotal = internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_Kc + internal->dim_R0t_1 + 1;
  internal->offset_output_R0t_1 = internal->dim_FOI1 + 1;
  internal->offset_variable_incubA = internal->dim_Lwb + internal->dim_Lwt + internal->dim_Mwb_E1 + internal->dim_Mwb_E2 + internal->dim_Mwb_I1 + internal->dim_Mwb_S + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_I1 + internal->dim_Mwt_S;
  internal->offset_variable_incubB = internal->dim_incubA + internal->dim_Lwb + internal->dim_Lwt + internal->dim_Mwb_E1 + internal->dim_Mwb_E2 + internal->dim_Mwb_I1 + internal->dim_Mwb_S + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_I1 + internal->dim_Mwt_S;
  internal->offset_variable_infectiousA = internal->dim_incubA + internal->dim_incubB + internal->dim_Lwb + internal->dim_Lwt + internal->dim_Mwb_E1 + internal->dim_Mwb_E2 + internal->dim_Mwb_I1 + internal->dim_Mwb_S + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_I1 + internal->dim_Mwt_S;
  internal->offset_variable_infectiousB = internal->dim_incubA + internal->dim_incubB + internal->dim_infectiousA + internal->dim_Lwb + internal->dim_Lwt + internal->dim_Mwb_E1 + internal->dim_Mwb_E2 + internal->dim_Mwb_I1 + internal->dim_Mwb_S + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_I1 + internal->dim_Mwt_S;
  internal->offset_variable_Lwb = internal->dim_Lwt + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_I1 + internal->dim_Mwt_S;
  internal->offset_variable_Mwb_E1 = internal->dim_Lwb + internal->dim_Lwt + internal->dim_Mwb_S + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_I1 + internal->dim_Mwt_S;
  internal->offset_variable_Mwb_E2 = internal->dim_Lwb + internal->dim_Lwt + internal->dim_Mwb_E1 + internal->dim_Mwb_S + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_I1 + internal->dim_Mwt_S;
  internal->offset_variable_Mwb_I1 = internal->dim_Lwb + internal->dim_Lwt + internal->dim_Mwb_E1 + internal->dim_Mwb_E2 + internal->dim_Mwb_S + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_I1 + internal->dim_Mwt_S;
  internal->offset_variable_Mwb_S = internal->dim_Lwb + internal->dim_Lwt + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_I1 + internal->dim_Mwt_S;
  internal->offset_variable_Mwt_E1 = internal->dim_Lwt + internal->dim_Mwt_S;
  internal->offset_variable_Mwt_E2 = internal->dim_Lwt + internal->dim_Mwt_E1 + internal->dim_Mwt_S;
  internal->offset_variable_Mwt_I1 = internal->dim_Lwt + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_S;
  internal->offset_variable_S = internal->dim_incubA + internal->dim_incubB + internal->dim_infectiousA + internal->dim_infectiousB + internal->dim_Lwb + internal->dim_Lwt + internal->dim_Mwb_E1 + internal->dim_Mwb_E2 + internal->dim_Mwb_I1 + internal->dim_Mwb_S + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_I1 + internal->dim_Mwt_S;
  ...
  R_Free(internal->age_I1_trials);
  internal->age_I1_trials = (double*) R_Calloc(internal->dim_age_I1_trials, double);
  R_Free(internal->age_S);
  internal->age_S = (double*) R_Calloc(internal->dim_age_S, double);
  R_Free(internal->age_S_trials);
  internal->age_S_trials = (double*) R_Calloc(internal->dim_age_S_trials, double);
  R_Free(internal->inf_1);
  internal->inf_1 = (double*) R_Calloc(internal->dim_inf_1, double);
  R_Free(internal->inf_1_prob);
  internal->inf_1_prob = (double*) R_Calloc(internal->dim_inf_1_prob, double);
  R_Free(internal->initial_I1);
  internal->initial_I1 = (double*) R_Calloc(internal->dim_I1, double);
  R_Free(internal->initial_R1);
  internal->initial_R1 = (double*) R_Calloc(internal->dim_R1, double);
  R_Free(internal->initial_S);
  internal->initial_S = (double*) R_Calloc(internal->dim_S, double);
  R_Free(internal->n_I1);
  internal->n_I1 = (double*) R_Calloc(internal->dim_n_I1, double);
  R_Free(internal->n_R1);
  internal->n_R1 = (double*) R_Calloc(internal->dim_n_R1, double);
  R_Free(internal->n_S);
  internal->n_S = (double*) R_Calloc(internal->dim_n_S, double);
  R_Free(internal->Ntotal);
  internal->Ntotal = (double*) R_Calloc(internal->dim_Ntotal, double);
  R_Free(internal->Ntotal_sum);
  internal->Ntotal_sum = (double*) R_Calloc(internal->dim_Ntotal_sum, double);
  R_Free(internal->O_I1);
  internal->O_I1 = (double*) R_Calloc(internal->dim_O_I1, double);
  R_Free(internal->O_R1);
  internal->O_R1 = (double*) R_Calloc(internal->dim_O_R1, double);
  R_Free(internal->O_S);
  internal->O_S = (double*) R_Calloc(internal->dim_O_S, double);
  R_Free(internal->O_S_prob);
  internal->O_S_prob = (double*) R_Calloc(internal->dim_O_S_prob, double);
  R_Free(internal->recov1);
  internal->recov1 = (double*) R_Calloc(internal->dim_recov1, double);
  R_Free(internal->Y1);
  internal->Y1 = (double*) R_Calloc(internal->dim_Y1, double);
  R_Free(internal->Y1T_sum);
  internal->Y1T_sum = (double*) R_Calloc(internal->dim_Y1T_sum, double);
  ...
  internal->offset_output_inf_1 = internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_Kc + internal->dim_Ntotal + internal->dim_R0t_1 + 1;
  internal->offset_variable_I1 = internal->dim_incubA + internal->dim_incubB + internal->dim_infectiousA + internal->dim_infectiousB + internal->dim_Lwb + internal->dim_Lwt + internal->dim_Mwb_E1 + internal->dim_Mwb_E2 + internal->dim_Mwb_I1 + internal->dim_Mwb_S + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_I1 + internal->dim_Mwt_S + internal->dim_S;
  internal->offset_variable_R1 = internal->dim_I1 + internal->dim_incubA + internal->dim_incubB + internal->dim_infectiousA + internal->dim_infectiousB + internal->dim_Lwb + internal->dim_Lwt + internal->dim_Mwb_E1 + internal->dim_Mwb_E2 + internal->dim_Mwb_I1 + internal->dim_Mwb_S + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_I1 + internal->dim_Mwt_S + internal->dim_S;
  ...
  R_Free(internal->age_I1);
  internal->age_I1 = (double*) R_Calloc(internal->dim_age_I1, double);
  R_Free(internal->age_R1);
  internal->age_R1 = (double*) R_Calloc(internal->dim_age_R1, double);
  R_Free(internal->vacc_noncov);
  internal->vacc_noncov = (double*) R_Calloc(internal->dim_vacc_noncov, double);
  R_Free(internal->vcu_noncov);
  internal->vcu_noncov = (double*) R_Calloc(internal->dim_vcu_noncov, double);
...
SEXP odin_model_determ_metadata(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(output_length, 5, ScalarInteger(internal->dim_eip));
  SET_VECTOR_ELT(output_length, 6, allocVector(INTSXP, 3));
  int * dim_Ntotal = INTEGER(VECTOR_ELT(output_length, 6));
  dim_Ntotal[0] = internal->dim_Ntotal_1;
  dim_Ntotal[1] = internal->dim_Ntotal_2;
  dim_Ntotal[2] = internal->dim_Ntotal_3;
  SET_VECTOR_ELT(output_length, 7, allocVector(INTSXP, 3));
  int * dim_inf_1 = INTEGER(VECTOR_ELT(output_length, 7));
  ...
  SET_STRING_ELT(output_names, 5, mkChar("eip"));
  SET_STRING_ELT(output_names, 6, mkChar("Ntotal"));
  SET_STRING_ELT(output_names, 7, mkChar("inf_1"));
  SET_VECTOR_ELT(ret, 1, output_length);
  UNPROTECT(2);
  SET_VECTOR_ELT(ret, 2, ScalarInteger(internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_inf_1 + internal->dim_Kc + internal->dim_Ntotal + internal->dim_R0t_1 + 1));
  UNPROTECT(2);
  return ret;
}
SEXP odin_model_determ_initial_conditions(SEXP internal_p, SEXP step_ptr) {
  ...
  SEXP r_state = PROTECT(allocVector(REALSXP, internal->dim_I1 + internal->dim_incubA + internal->dim_incubB + internal->dim_infectiousA + internal->dim_infectiousB + internal->dim_Lwb + internal->dim_Lwt + internal->dim_Mwb_E1 + internal->dim_Mwb_E2 + internal->dim_Mwb_I1 + internal->dim_Mwb_S + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_I1 + internal->dim_Mwt_S + internal->dim_R1 + internal->dim_S));
...
SEXP odin_model_determ_rhs_r(SEXP internal_p, SEXP step, SEXP state) {
  ...
  odin_model_determ_internal *internal = odin_model_determ_get_internal(internal_p, 1);
  SEXP output_ptr = PROTECT(allocVector(REALSXP, internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_inf_1 + internal->dim_Kc + internal->dim_Ntotal + internal->dim_R0t_1 + 1));
  setAttrib(state_next, install("output"), output_ptr);
  UNPROTECT(1);
  double *output = REAL(output_ptr);
  odin_model_determ_rhs(internal, scalar_int(step, "step"), REAL(state), REAL(state_next), output);
  UNPROTECT(1);
  return state_next;
}
odin_model_stoch_internal* odin_model_stoch_get_internal(SEXP internal_p, int closed_error) {
...
void odin_model_stoch_finalise(SEXP internal_p) {
  ...
  if (internal_p) {
    ...
    R_Free(internal->O_S_prob);
    R_Free(internal->phi1);
    R_Free(internal->prop_Sp);
    R_Free(internal->recov1);
    R_Free(internal->recov1_prob);
    R_Free(internal->rho1);
    R_Free(internal->season_amp);
    R_Free(internal->season_phase);
    R_Free(internal->sum_S);
    R_Free(internal->Y1);
    R_Free(internal->Y1T);
    R_Free(internal->Y1T_sum);
    R_Free(internal);
...
SEXP odin_model_stoch_create(SEXP user) {
  odin_model_stoch_internal *internal = (odin_model_stoch_internal*) R_Calloc(1, odin_model_stoch_internal);
  internal->age_I1 = NULL;
  internal->age_I1_prob = NULL;
  internal->age_I1_trials = NULL;
  internal->age_R1 = NULL;
...
SEXP odin_model_stoch_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->FOI1p = (double*) R_Calloc(internal->dim_FOI1p, double);
  R_Free(internal->FOI1Y);
  internal->FOI1Y = (double*) R_Calloc(internal->dim_FOI1Y, double);
  R_Free(internal->infectious1);
  internal->infectious1 = (double*) R_Calloc(internal->dim_infectious1, double);
  R_Free(internal->initial_incubA);
  internal->initial_incubA = (double*) R_Calloc(internal->dim_incubA, double);
  ...
  internal->O_R1_prob = (double*) R_Calloc(internal->dim_O_R1_prob, double);
  R_Free(internal->prop_Sp);
  internal->prop_Sp = (double*) R_Calloc(internal->dim_prop_Sp, double);
  R_Free(internal->recov1_prob);
  internal->recov1_prob = (double*) R_Calloc(internal->dim_recov1_prob, double);
  R_Free(internal->Y1T);
  internal->Y1T = (double*) R_Calloc(internal->dim_Y1T, double);
  ...
  internal->N_eq = (double*) user_get_array(user, false, internal->N_eq, "N_eq", NA_REAL, NA_REAL, 1, internal->dim_N_eq);
  internal->Nb = (double*) user_get_array(user, false, internal->Nb, "Nb", NA_REAL, NA_REAL, 1, internal->dim_Nb);
  internal->offset_output_births = internal->dim_agert + internal->dim_deathrt + 7;
  internal->offset_output_deathrt = internal->dim_agert + 7;
  internal->offset_output_Delta = internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_Kc + internal->dim_prop_Sp + internal->dim_Y1T + 7;
  internal->offset_output_eip = internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_Kc + internal->dim_prop_Sp + internal->dim_Y1T + 7;
  internal->offset_output_FOI1 = internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Y1T + 7;
  internal->offset_output_FOI1nn = internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_FOI1 + internal->dim_FOI1p + internal->dim_Y1T + 7;
  internal->offset_output_FOI1p = internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_FOI1 + internal->dim_Y1T + 7;
  internal->offset_output_FOI1Y = internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_prop_Sp + internal->dim_Y1T + 7;
  internal->offset_output_infectious1 = internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_Kc + internal->dim_Mwt_FOI1 + internal->dim_NTp + internal->dim_prop_Sp + internal->dim_rho1 + internal->dim_Y1T + 7;
  internal->offset_output_Kc = internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_prop_Sp + internal->dim_Y1T + 7;
  internal->offset_output_Lwt_birth = internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_infectious1 + internal->dim_Kc + internal->dim_Mwt_FOI1 + internal->dim_Mwt_tot + internal->dim_NTp + internal->dim_prop_Sp + internal->dim_rho1 + internal->dim_Y1T + 7;
  internal->offset_output_Lwt_mature = internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_infectious1 + internal->dim_Kc + internal->dim_Lwt_birth + internal->dim_Mwt_FOI1 + internal->dim_Mwt_inf1 + internal->dim_Mwt_tot + internal->dim_NTp + internal->dim_O_Mwt_E1 + internal->dim_O_Mwt_S + internal->dim_prop_Sp + internal->dim_rho1 + internal->dim_Y1T + 7;
  internal->offset_output_Mwt_FOI1 = internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_Kc + internal->dim_NTp + internal->dim_prop_Sp + internal->dim_Y1T + 7;
  internal->offset_output_Mwt_inf1 = internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_infectious1 + internal->dim_Kc + internal->dim_Lwt_birth + internal->dim_Mwt_FOI1 + internal->dim_Mwt_tot + internal->dim_NTp + internal->dim_prop_Sp + internal->dim_rho1 + internal->dim_Y1T + 7;
  internal->offset_output_Mwt_tot = internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_infectious1 + internal->dim_Kc + internal->dim_Mwt_FOI1 + internal->dim_NTp + internal->dim_prop_Sp + internal->dim_rho1 + internal->dim_Y1T + 7;
  internal->offset_output_Ntotal = internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_infectious1 + internal->dim_Kc + internal->dim_Lwt_birth + internal->dim_Lwt_mature + internal->dim_Mwt_FOI1 + internal->dim_Mwt_inf1 + internal->dim_Mwt_tot + internal->dim_NTp + internal->dim_O_Mwt_E1 + internal->dim_O_Mwt_S + internal->dim_prop_Sp + internal->dim_rho1 + internal->dim_Y1T + 7;
  internal->offset_output_NTp = internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_Kc + internal->dim_prop_Sp + internal->dim_Y1T + 7;
  internal->offset_output_O_Mwt_E1 = internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_infectious1 + internal->dim_Kc + internal->dim_Lwt_birth + internal->dim_Mwt_FOI1 + internal->dim_Mwt_inf1 + internal->dim_Mwt_tot + internal->dim_NTp + internal->dim_prop_Sp + internal->dim_rho1 + internal->dim_Y1T + 7;
  internal->offset_output_O_Mwt_S = internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_infectious1 + internal->dim_Kc + internal->dim_Lwt_birth + internal->dim_Mwt_FOI1 + internal->dim_Mwt_inf1 + internal->dim_Mwt_tot + internal->dim_NTp + internal->dim_O_Mwt_E1 + internal->dim_prop_Sp + internal->dim_rho1 + internal->dim_Y1T + 7;
  internal->offset_output_prop_Sp = internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_Y1T + 7;
  internal->offset_output_rho1 = internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_Kc + internal->dim_Mwt_FOI1 + internal->dim_NTp + internal->dim_prop_Sp + internal->dim_Y1T + 7;
  internal->offset_output_Y1T = internal->dim_agert + internal->dim_births + internal->dim_deathrt + 7;
  internal->offset_variable_incubA = internal->dim_Lwt + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_I1 + internal->dim_Mwt_S;
  internal->offset_variable_incubB = internal->dim_incubA + internal->dim_Lwt + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_I1 + internal->dim_Mwt_S;
  internal->offset_variable_infectiousA = internal->dim_incubA + internal->dim_incubB + internal->dim_Lwt + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_I1 + internal->dim_Mwt_S;
  internal->offset_variable_infectiousB = internal->dim_incubA + internal->dim_incubB + internal->dim_infectiousA + internal->dim_Lwt + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_I1 + internal->dim_Mwt_S;
  internal->offset_variable_Mwt_E1 = internal->dim_Lwt + internal->dim_Mwt_S;
  internal->offset_variable_Mwt_E2 = internal->dim_Lwt + internal->dim_Mwt_E1 + internal->dim_Mwt_S;
  internal->offset_variable_Mwt_I1 = internal->dim_Lwt + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_S;
  internal->offset_variable_S = internal->dim_incubA + internal->dim_incubB + internal->dim_infectiousA + internal->dim_infectiousB + internal->dim_Lwt + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_I1 + internal->dim_Mwt_S;
  ...
  internal->recov1 = (double*) R_Calloc(internal->dim_recov1, double);
  R_Free(internal->sum_S);
  internal->sum_S = (double*) R_Calloc(internal->dim_sum_S, double);
  R_Free(internal->Y1);
  internal->Y1 = (double*) R_Calloc(internal->dim_Y1, double);
  R_Free(internal->Y1T_sum);
  internal->Y1T_sum = (double*) R_Calloc(internal->dim_Y1T_sum, double);
  ...
  internal->nn = (int*) user_get_array(user, true, internal->nn, "nn", NA_REAL, NA_REAL, 2, internal->dim_nn_1, internal->dim_nn_2);
  internal->offset_output_age_I1 = internal->dim_age_S + internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_inf_1 + internal->dim_infectious1 + internal->dim_Kc + internal->dim_Lwt_birth + internal->dim_Lwt_mature + internal->dim_Mwt_FOI1 + internal->dim_Mwt_inf1 + internal->dim_Mwt_tot + internal->dim_Ntotal + internal->dim_NTp + internal->dim_O_I1 + internal->dim_O_Mwt_E1 + internal->dim_O_Mwt_S + internal->dim_O_S + internal->dim_prop_Sp + internal->dim_recov1 + internal->dim_rho1 + internal->dim_Y1T + 7;
  internal->offset_output_age_S = internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_inf_1 + internal->dim_infectious1 + internal->dim_Kc + internal->dim_Lwt_birth + internal->dim_Lwt_mature + internal->dim_Mwt_FOI1 + internal->dim_Mwt_inf1 + internal->dim_Mwt_tot + internal->dim_Ntotal + internal->dim_NTp + internal->dim_O_Mwt_E1 + internal->dim_O_Mwt_S + internal->dim_O_S + internal->dim_prop_Sp + internal->dim_rho1 + internal->dim_Y1T + 7;
  internal->offset_output_inf_1 = internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_infectious1 + internal->dim_Kc + internal->dim_Lwt_birth + internal->dim_Lwt_mature + internal->dim_Mwt_FOI1 + internal->dim_Mwt_inf1 + internal->dim_Mwt_tot + internal->dim_Ntotal + internal->dim_NTp + internal->dim_O_Mwt_E1 + internal->dim_O_Mwt_S + internal->dim_O_S + internal->dim_prop_Sp + internal->dim_rho1 + internal->dim_Y1T + 7;
  internal->offset_output_O_I1 = internal->dim_age_S + internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_inf_1 + internal->dim_infectious1 + internal->dim_Kc + internal->dim_Lwt_birth + internal->dim_Lwt_mature + internal->dim_Mwt_FOI1 + internal->dim_Mwt_inf1 + internal->dim_Mwt_tot + internal->dim_Ntotal + internal->dim_NTp + internal->dim_O_Mwt_E1 + internal->dim_O_Mwt_S + internal->dim_O_S + internal->dim_prop_Sp + internal->dim_rho1 + internal->dim_Y1T + 7;
  internal->offset_output_O_S = internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_infectious1 + internal->dim_Kc + internal->dim_Lwt_birth + internal->dim_Lwt_mature + internal->dim_Mwt_FOI1 + internal->dim_Mwt_inf1 + internal->dim_Mwt_tot + internal->dim_Ntotal + internal->dim_NTp + internal->dim_O_Mwt_E1 + internal->dim_O_Mwt_S + internal->dim_prop_Sp + internal->dim_rho1 + internal->dim_Y1T + 7;
  internal->offset_output_recov1 = internal->dim_age_S + internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_inf_1 + internal->dim_infectious1 + internal->dim_Kc + internal->dim_Lwt_birth + internal->dim_Lwt_mature + internal->dim_Mwt_FOI1 + internal->dim_Mwt_inf1 + internal->dim_Mwt_tot + internal->dim_Ntotal + internal->dim_NTp + internal->dim_O_I1 + internal->dim_O_Mwt_E1 + internal->dim_O_Mwt_S + internal->dim_O_S + internal->dim_prop_Sp + internal->dim_rho1 + internal->dim_Y1T + 7;
  internal->offset_variable_I1 = internal->dim_incubA + internal->dim_incubB + internal->dim_infectiousA + internal->dim_infectiousB + internal->dim_Lwt + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_I1 + internal->dim_Mwt_S + internal->dim_S;
  internal->offset_variable_R1 = internal->dim_I1 + internal->dim_incubA + internal->dim_incubB + internal->dim_infectiousA + internal->dim_infectiousB + internal->dim_Lwt + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_I1 + internal->dim_Mwt_S + internal->dim_S;
  R_Free(internal->age_I1);
  internal->age_I1 = (double*) R_Calloc(internal->dim_age_I1, double);
  R_Free(internal->age_R1);
  internal->age_R1 = (double*) R_Calloc(internal->dim_age_R1, double);
  ...
  internal->offset_output_age_R1 = internal->dim_age_I1 + internal->dim_age_S + internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_inf_1 + internal->dim_infectious1 + internal->dim_Kc + internal->dim_Lwt_birth + internal->dim_Lwt_mature + internal->dim_Mwt_FOI1 + internal->dim_Mwt_inf1 + internal->dim_Mwt_tot + internal->dim_Ntotal + internal->dim_NTp + internal->dim_O_I1 + internal->dim_O_Mwt_E1 + internal->dim_O_Mwt_S + internal->dim_O_R1 + internal->dim_O_S + internal->dim_prop_Sp + internal->dim_recov1 + internal->dim_rho1 + internal->dim_Y1T + 7;
  internal->offset_output_inf_1_prob = internal->dim_age_I1 + internal->dim_age_R1 + internal->dim_age_S + internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_inf_1 + internal->dim_infectious1 + internal->dim_Kc + internal->dim_Lwt_birth + internal->dim_Lwt_mature + internal->dim_Mwt_FOI1 + internal->dim_Mwt_inf1 + internal->dim_Mwt_tot + internal->dim_Ntotal + internal->dim_NTp + internal->dim_O_I1 + internal->dim_O_Mwt_E1 + internal->dim_O_Mwt_S + internal->dim_O_R1 + internal->dim_O_S + internal->dim_prop_Sp + internal->dim_recov1 + internal->dim_rho1 + internal->dim_Y1T + 7;
  internal->offset_output_O_R1 = internal->dim_age_I1 + internal->dim_age_S + internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_inf_1 + internal->dim_infectious1 + internal->dim_Kc + internal->dim_Lwt_birth + internal->dim_Lwt_mature + internal->dim_Mwt_FOI1 + internal->dim_Mwt_inf1 + internal->dim_Mwt_tot + internal->dim_Ntotal + internal->dim_NTp + internal->dim_O_I1 + internal->dim_O_Mwt_E1 + internal->dim_O_Mwt_S + internal->dim_O_S + internal->dim_prop_Sp + internal->dim_recov1 + internal->dim_rho1 + internal->dim_Y1T + 7;
  internal->offset_output_O_S_prob = internal->dim_age_I1 + internal->dim_age_R1 + internal->dim_age_S + internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_inf_1 + internal->dim_inf_1_prob + internal->dim_infectious1 + internal->dim_Kc + internal->dim_Lwt_birth + internal->dim_Lwt_mature + internal->dim_Mwt_FOI1 + internal->dim_Mwt_inf1 + internal->dim_Mwt_tot + internal->dim_Ntotal + internal->dim_NTp + internal->dim_O_I1 + internal->dim_O_Mwt_E1 + internal->dim_O_Mwt_S + internal->dim_O_R1 + internal->dim_O_S + internal->dim_prop_Sp + internal->dim_recov1 + internal->dim_rho1 + internal->dim_Y1T + 7;
  return R_NilValue;
}
SEXP odin_model_stoch_set_initial(SEXP internal_p, SEXP step_ptr, SEXP state_ptr) {
  return R_NilValue;
...
SEXP odin_model_stoch_metadata(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(ret, 1, output_length);
  UNPROTECT(2);
  SET_VECTOR_ELT(ret, 2, ScalarInteger(internal->dim_age_I1 + internal->dim_age_R1 + internal->dim_age_S + internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_inf_1 + internal->dim_inf_1_prob + internal->dim_infectious1 + internal->dim_Kc + internal->dim_Lwt_birth + internal->dim_Lwt_mature + internal->dim_Mwt_FOI1 + internal->dim_Mwt_inf1 + internal->dim_Mwt_tot + internal->dim_Ntotal + internal->dim_NTp + internal->dim_O_I1 + internal->dim_O_Mwt_E1 + internal->dim_O_Mwt_S + internal->dim_O_R1 + internal->dim_O_S + internal->dim_O_S_prob + internal->dim_prop_Sp + internal->dim_recov1 + internal->dim_rho1 + internal->dim_Y1T + 7));
  UNPROTECT(2);
  return ret;
}
SEXP odin_model_stoch_initial_conditions(SEXP internal_p, SEXP step_ptr) {
  ...
  PutRNGstate();
  SEXP r_state = PROTECT(allocVector(REALSXP, internal->dim_I1 + internal->dim_incubA + internal->dim_incubB + internal->dim_infectiousA + internal->dim_infectiousB + internal->dim_Lwt + internal->dim_Mwt_E1 + internal->dim_Mwt_E2 + internal->dim_Mwt_I1 + internal->dim_Mwt_S + internal->dim_R1 + internal->dim_S));
  double * state = REAL(r_state);
  memcpy(state + 0, internal->initial_Lwt, internal->dim_Lwt * sizeof(double));
  memcpy(state + internal->dim_Lwt, internal->initial_Mwt_S, internal->dim_Mwt_S * sizeof(double));
  memcpy(state + internal->offset_variable_Mwt_E1, internal->initial_Mwt_E1, internal->dim_Mwt_E1 * sizeof(double));
...
SEXP odin_model_stoch_rhs_r(SEXP internal_p, SEXP step, SEXP state) {
  SEXP state_next = PROTECT(allocVector(REALSXP, LENGTH(state)));
  odin_model_stoch_internal *internal = odin_model_stoch_get_internal(internal_p, 1);
  SEXP output_ptr = PROTECT(allocVector(REALSXP, internal->dim_age_I1 + internal->dim_age_R1 + internal->dim_age_S + internal->dim_agert + internal->dim_births + internal->dim_deathrt + internal->dim_Delta + internal->dim_eip + internal->dim_FOI1 + internal->dim_FOI1nn + internal->dim_FOI1p + internal->dim_FOI1Y + internal->dim_inf_1 + internal->dim_inf_1_prob + internal->dim_infectious1 + internal->dim_Kc + internal->dim_Lwt_birth + internal->dim_Lwt_mature + internal->dim_Mwt_FOI1 + internal->dim_Mwt_inf1 + internal->dim_Mwt_tot + internal->dim_Ntotal + internal->dim_NTp + internal->dim_O_I1 + internal->dim_O_Mwt_E1 + internal->dim_O_Mwt_S + internal->dim_O_R1 + internal->dim_O_S + internal->dim_O_S_prob + internal->dim_prop_Sp + internal->dim_recov1 + internal->dim_rho1 + internal->dim_Y1T + 7));
  setAttrib(state_next, install("output"), output_ptr);
  UNPROTECT(1);
  double *output = REAL(output_ptr);
  GetRNGstate();
  odin_model_stoch_rhs(internal, scalar_int(step, "step"), REAL(state), REAL(state_next), output);
  PutRNGstate();
  UNPROTECT(1);
  return state_next;
}
