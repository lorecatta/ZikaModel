...
SEXP odin_model_determ_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 426));
  ...
  SET_VECTOR_ELT(contents, 113, ScalarInteger(internal->dim_M_tot));
  SET_VECTOR_ELT(contents, 114, ScalarInteger(internal->dim_Mwb_E1));
  SET_VECTOR_ELT(contents, 115, ScalarInteger(internal->dim_Mwb_E1_incub));
  SET_VECTOR_ELT(contents, 116, ScalarInteger(internal->dim_Mwb_E1_incub_prob));
  SET_VECTOR_ELT(contents, 117, ScalarInteger(internal->dim_Mwb_E2));
  SET_VECTOR_ELT(contents, 118, ScalarInteger(internal->dim_Mwb_E2_incub));
  SET_VECTOR_ELT(contents, 119, ScalarInteger(internal->dim_Mwb_E2_incub_prob));
  SET_VECTOR_ELT(contents, 120, ScalarInteger(internal->dim_Mwb_FOI1));
  SET_VECTOR_ELT(contents, 121, ScalarInteger(internal->dim_Mwb_I1));
  SET_VECTOR_ELT(contents, 122, ScalarInteger(internal->dim_Mwb_inf1));
  SET_VECTOR_ELT(contents, 123, ScalarInteger(internal->dim_Mwb_inf1_prob));
  SET_VECTOR_ELT(contents, 124, ScalarInteger(internal->dim_Mwb_intro));
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->dim_Mwb_S));
  SET_VECTOR_ELT(contents, 126, ScalarInteger(internal->dim_Mwb_tot));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->dim_Mwt));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->dim_Mwt_E1));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->dim_Mwt_E1_incub));
  SET_VECTOR_ELT(contents, 130, ScalarInteger(internal->dim_Mwt_E1_incub_prob));
  SET_VECTOR_ELT(contents, 131, ScalarInteger(internal->dim_Mwt_E2));
  SET_VECTOR_ELT(contents, 132, ScalarInteger(internal->dim_Mwt_E2_incub));
  SET_VECTOR_ELT(contents, 133, ScalarInteger(internal->dim_Mwt_E2_incub_prob));
  SET_VECTOR_ELT(contents, 134, ScalarInteger(internal->dim_Mwt_FOI1));
  SET_VECTOR_ELT(contents, 135, ScalarInteger(internal->dim_Mwt_I1));
  SET_VECTOR_ELT(contents, 136, ScalarInteger(internal->dim_Mwt_inf1));
  SET_VECTOR_ELT(contents, 137, ScalarInteger(internal->dim_Mwt_inf1_prob));
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->dim_Mwt_S));
  SET_VECTOR_ELT(contents, 139, ScalarInteger(internal->dim_Mwt_tot));
  SET_VECTOR_ELT(contents, 140, ScalarInteger(internal->dim_N_eq));
  SET_VECTOR_ELT(contents, 141, ScalarInteger(internal->dim_n_I1));
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->dim_n_I1_1));
  SET_VECTOR_ELT(contents, 143, ScalarInteger(internal->dim_n_I1_12));
  SET_VECTOR_ELT(contents, 144, ScalarInteger(internal->dim_n_I1_2));
  SET_VECTOR_ELT(contents, 145, ScalarInteger(internal->dim_n_I1_3));
  SET_VECTOR_ELT(contents, 146, ScalarInteger(internal->dim_n_R1));
  SET_VECTOR_ELT(contents, 147, ScalarInteger(internal->dim_n_R1_1));
  SET_VECTOR_ELT(contents, 148, ScalarInteger(internal->dim_n_R1_12));
  SET_VECTOR_ELT(contents, 149, ScalarInteger(internal->dim_n_R1_2));
  SET_VECTOR_ELT(contents, 150, ScalarInteger(internal->dim_n_R1_3));
  SET_VECTOR_ELT(contents, 151, ScalarInteger(internal->dim_n_S));
  SET_VECTOR_ELT(contents, 152, ScalarInteger(internal->dim_n_S_1));
  SET_VECTOR_ELT(contents, 153, ScalarInteger(internal->dim_n_S_12));
  SET_VECTOR_ELT(contents, 154, ScalarInteger(internal->dim_n_S_2));
  SET_VECTOR_ELT(contents, 155, ScalarInteger(internal->dim_n_S_3));
  SET_VECTOR_ELT(contents, 156, ScalarInteger(internal->dim_Nb));
  SET_VECTOR_ELT(contents, 157, ScalarInteger(internal->dim_nn));
  SET_VECTOR_ELT(contents, 158, ScalarInteger(internal->dim_nn_1));
  SET_VECTOR_ELT(contents, 159, ScalarInteger(internal->dim_nn_2));
  SET_VECTOR_ELT(contents, 160, ScalarInteger(internal->dim_Ntotal));
  SET_VECTOR_ELT(contents, 161, ScalarInteger(internal->dim_Ntotal_1));
  SET_VECTOR_ELT(contents, 162, ScalarInteger(internal->dim_Ntotal_12));
  SET_VECTOR_ELT(contents, 163, ScalarInteger(internal->dim_Ntotal_2));
  SET_VECTOR_ELT(contents, 164, ScalarInteger(internal->dim_Ntotal_3));
  SET_VECTOR_ELT(contents, 165, ScalarInteger(internal->dim_Ntotal_sum));
  SET_VECTOR_ELT(contents, 166, ScalarInteger(internal->dim_Ntotal_sum_1));
  SET_VECTOR_ELT(contents, 167, ScalarInteger(internal->dim_Ntotal_sum_2));
  SET_VECTOR_ELT(contents, 168, ScalarInteger(internal->dim_NTp));
  SET_VECTOR_ELT(contents, 169, ScalarInteger(internal->dim_O_I1));
  SET_VECTOR_ELT(contents, 170, ScalarInteger(internal->dim_O_I1_1));
  SET_VECTOR_ELT(contents, 171, ScalarInteger(internal->dim_O_I1_12));
  SET_VECTOR_ELT(contents, 172, ScalarInteger(internal->dim_O_I1_2));
  SET_VECTOR_ELT(contents, 173, ScalarInteger(internal->dim_O_I1_3));
  SET_VECTOR_ELT(contents, 174, ScalarInteger(internal->dim_O_I1_prob));
  SET_VECTOR_ELT(contents, 175, ScalarInteger(internal->dim_O_Lwb));
  SET_VECTOR_ELT(contents, 176, ScalarInteger(internal->dim_O_Lwb_prob));
  SET_VECTOR_ELT(contents, 177, ScalarInteger(internal->dim_O_Lwt));
  SET_VECTOR_ELT(contents, 178, ScalarInteger(internal->dim_O_Lwt_prob));
  SET_VECTOR_ELT(contents, 179, ScalarInteger(internal->dim_O_Mwb_E1));
  SET_VECTOR_ELT(contents, 180, ScalarInteger(internal->dim_O_Mwb_E1_prob));
  SET_VECTOR_ELT(contents, 181, ScalarInteger(internal->dim_O_Mwb_E2));
  SET_VECTOR_ELT(contents, 182, ScalarInteger(internal->dim_O_Mwb_E2_prob));
  SET_VECTOR_ELT(contents, 183, ScalarInteger(internal->dim_O_Mwb_I1));
  SET_VECTOR_ELT(contents, 184, ScalarInteger(internal->dim_O_Mwb_I1_prob));
  SET_VECTOR_ELT(contents, 185, ScalarInteger(internal->dim_O_Mwb_S));
  SET_VECTOR_ELT(contents, 186, ScalarInteger(internal->dim_O_Mwb_S_prob));
  SET_VECTOR_ELT(contents, 187, ScalarInteger(internal->dim_O_Mwt_E1));
  SET_VECTOR_ELT(contents, 188, ScalarInteger(internal->dim_O_Mwt_E1_prob));
  SET_VECTOR_ELT(contents, 189, ScalarInteger(internal->dim_O_Mwt_E2));
  SET_VECTOR_ELT(contents, 190, ScalarInteger(internal->dim_O_Mwt_E2_prob));
  SET_VECTOR_ELT(contents, 191, ScalarInteger(internal->dim_O_Mwt_I1));
  SET_VECTOR_ELT(contents, 192, ScalarInteger(internal->dim_O_Mwt_I1_prob));
  SET_VECTOR_ELT(contents, 193, ScalarInteger(internal->dim_O_Mwt_S));
  SET_VECTOR_ELT(contents, 194, ScalarInteger(internal->dim_O_Mwt_S_prob));
  SET_VECTOR_ELT(contents, 195, ScalarInteger(internal->dim_O_R1));
  SET_VECTOR_ELT(contents, 196, ScalarInteger(internal->dim_O_R1_1));
  SET_VECTOR_ELT(contents, 197, ScalarInteger(internal->dim_O_R1_12));
  SET_VECTOR_ELT(contents, 198, ScalarInteger(internal->dim_O_R1_2));
  SET_VECTOR_ELT(contents, 199, ScalarInteger(internal->dim_O_R1_3));
  SET_VECTOR_ELT(contents, 200, ScalarInteger(internal->dim_O_R1_prob));
  SET_VECTOR_ELT(contents, 201, ScalarInteger(internal->dim_O_S));
  SET_VECTOR_ELT(contents, 202, ScalarInteger(internal->dim_O_S_1));
  SET_VECTOR_ELT(contents, 203, ScalarInteger(internal->dim_O_S_12));
  SET_VECTOR_ELT(contents, 204, ScalarInteger(internal->dim_O_S_2));
  SET_VECTOR_ELT(contents, 205, ScalarInteger(internal->dim_O_S_3));
  SET_VECTOR_ELT(contents, 206, ScalarInteger(internal->dim_O_S_prob));
  SET_VECTOR_ELT(contents, 207, ScalarInteger(internal->dim_O_S_prob_1));
  SET_VECTOR_ELT(contents, 208, ScalarInteger(internal->dim_O_S_prob_12));
  SET_VECTOR_ELT(contents, 209, ScalarInteger(internal->dim_O_S_prob_2));
  SET_VECTOR_ELT(contents, 210, ScalarInteger(internal->dim_O_S_prob_3));
  SET_VECTOR_ELT(contents, 211, ScalarInteger(internal->dim_phi1));
  SET_VECTOR_ELT(contents, 212, ScalarInteger(internal->dim_prop_wb));
  SET_VECTOR_ELT(contents, 213, ScalarInteger(internal->dim_R0t_1));
  SET_VECTOR_ELT(contents, 214, ScalarInteger(internal->dim_R1));
  SET_VECTOR_ELT(contents, 215, ScalarInteger(internal->dim_R1_1));
  SET_VECTOR_ELT(contents, 216, ScalarInteger(internal->dim_R1_12));
  SET_VECTOR_ELT(contents, 217, ScalarInteger(internal->dim_R1_2));
  SET_VECTOR_ELT(contents, 218, ScalarInteger(internal->dim_R1_3));
  SET_VECTOR_ELT(contents, 219, ScalarInteger(internal->dim_recov1));
  SET_VECTOR_ELT(contents, 220, ScalarInteger(internal->dim_recov1_1));
  SET_VECTOR_ELT(contents, 221, ScalarInteger(internal->dim_recov1_12));
  SET_VECTOR_ELT(contents, 222, ScalarInteger(internal->dim_recov1_2));
  SET_VECTOR_ELT(contents, 223, ScalarInteger(internal->dim_recov1_3));
  SET_VECTOR_ELT(contents, 224, ScalarInteger(internal->dim_recov1_prob));
  SET_VECTOR_ELT(contents, 225, ScalarInteger(internal->dim_rho1));
  SET_VECTOR_ELT(contents, 226, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 227, ScalarInteger(internal->dim_S_1));
  SET_VECTOR_ELT(contents, 228, ScalarInteger(internal->dim_S_12));
  SET_VECTOR_ELT(contents, 229, ScalarInteger(internal->dim_S_2));
  SET_VECTOR_ELT(contents, 230, ScalarInteger(internal->dim_S_3));
  SET_VECTOR_ELT(contents, 231, ScalarInteger(internal->dim_season_amp));
  SET_VECTOR_ELT(contents, 232, ScalarInteger(internal->dim_season_phases));
  SET_VECTOR_ELT(contents, 233, ScalarInteger(internal->dim_vacc_child_age));
  SET_VECTOR_ELT(contents, 234, ScalarInteger(internal->dim_vacc_cu_age));
  SET_VECTOR_ELT(contents, 235, ScalarInteger(internal->dim_vacc_noncov));
  SET_VECTOR_ELT(contents, 236, ScalarInteger(internal->dim_vacc_noncov_1));
  SET_VECTOR_ELT(contents, 237, ScalarInteger(internal->dim_vacc_noncov_2));
  SET_VECTOR_ELT(contents, 238, ScalarInteger(internal->dim_vcu_noncov));
  SET_VECTOR_ELT(contents, 239, ScalarInteger(internal->dim_vcu_noncov_1));
  SET_VECTOR_ELT(contents, 240, ScalarInteger(internal->dim_vcu_noncov_2));
  SET_VECTOR_ELT(contents, 241, ScalarInteger(internal->dim_Wb_introrate));
  SET_VECTOR_ELT(contents, 242, ScalarInteger(internal->dim_Wb_introtime));
  SET_VECTOR_ELT(contents, 243, ScalarInteger(internal->dim_Y1));
  SET_VECTOR_ELT(contents, 244, ScalarInteger(internal->dim_Y1_1));
  SET_VECTOR_ELT(contents, 245, ScalarInteger(internal->dim_Y1_12));
  SET_VECTOR_ELT(contents, 246, ScalarInteger(internal->dim_Y1_2));
  SET_VECTOR_ELT(contents, 247, ScalarInteger(internal->dim_Y1_3));
  SET_VECTOR_ELT(contents, 248, ScalarInteger(internal->dim_Y1T));
  SET_VECTOR_ELT(contents, 249, ScalarInteger(internal->dim_Y1T_sum));
  SET_VECTOR_ELT(contents, 250, ScalarInteger(internal->dim_Y1T_sum_1));
  SET_VECTOR_ELT(contents, 251, ScalarInteger(internal->dim_Y1T_sum_2));
  SET_VECTOR_ELT(contents, 252, ScalarReal(internal->DT));
  SEXP eip = PROTECT(allocVector(REALSXP, internal->dim_eip));
  memcpy(REAL(eip), internal->eip, internal->dim_eip * sizeof(double));
  SET_VECTOR_ELT(contents, 253, eip);
  SET_VECTOR_ELT(contents, 254, ScalarReal(internal->eip_mean));
  SET_VECTOR_ELT(contents, 255, ScalarReal(internal->eip_season));
  SET_VECTOR_ELT(contents, 256, ScalarReal(internal->Epsilon));
  SEXP FOI1 = PROTECT(allocVector(REALSXP, internal->dim_FOI1));
  memcpy(REAL(FOI1), internal->FOI1, internal->dim_FOI1 * sizeof(double));
  SET_VECTOR_ELT(contents, 257, FOI1);
  ...
  SET_VECTOR_ELT(contents, 258, FOI1nn);
  ...
  SET_VECTOR_ELT(contents, 259, FOI1p);
  SET_VECTOR_ELT(contents, 260, ScalarReal(internal->Gamma));
  SET_VECTOR_ELT(contents, 261, ScalarReal(internal->incub));
  ...
  SET_VECTOR_ELT(contents, 262, inf_1);
  ...
  SET_VECTOR_ELT(contents, 263, inf_1_prob);
  SET_VECTOR_ELT(contents, 264, ScalarReal(internal->inf_per));
  ...
  SET_VECTOR_ELT(contents, 265, infectious1);
  ...
  SET_VECTOR_ELT(contents, 266, init_I1);
  ...
  SET_VECTOR_ELT(contents, 267, init_R1);
  ...
  SET_VECTOR_ELT(contents, 268, init_S);
  ...
  SET_VECTOR_ELT(contents, 269, initial_I1);
  ...
  SET_VECTOR_ELT(contents, 270, initial_incubA);
  ...
  SET_VECTOR_ELT(contents, 271, initial_incubB);
  ...
  SET_VECTOR_ELT(contents, 272, initial_infectiousA);
  ...
  SET_VECTOR_ELT(contents, 273, initial_infectiousB);
  ...
  SET_VECTOR_ELT(contents, 274, initial_Lwb);
  ...
  SET_VECTOR_ELT(contents, 275, initial_Lwt);
  ...
  SET_VECTOR_ELT(contents, 276, initial_Mwb_E1);
  ...
  SET_VECTOR_ELT(contents, 277, initial_Mwb_E2);
  ...
  SET_VECTOR_ELT(contents, 278, initial_Mwb_I1);
  ...
  SET_VECTOR_ELT(contents, 279, initial_Mwb_S);
  ...
  SET_VECTOR_ELT(contents, 280, initial_Mwt_E1);
  ...
  SET_VECTOR_ELT(contents, 281, initial_Mwt_E2);
  ...
  SET_VECTOR_ELT(contents, 282, initial_Mwt_I1);
  ...
  SET_VECTOR_ELT(contents, 283, initial_Mwt_S);
  ...
  SET_VECTOR_ELT(contents, 284, initial_R1);
  ...
  SET_VECTOR_ELT(contents, 285, initial_S);
  SET_VECTOR_ELT(contents, 286, ScalarReal(internal->Kappa));
  SEXP Kc = PROTECT(allocVector(REALSXP, internal->dim_Kc));
  memcpy(REAL(Kc), internal->Kc, internal->dim_Kc * sizeof(double));
  SET_VECTOR_ELT(contents, 287, Kc);
  SET_VECTOR_ELT(contents, 288, ScalarReal(internal->Kc_mean));
  SET_VECTOR_ELT(contents, 289, ScalarReal(internal->Kc_season));
  ...
  SET_VECTOR_ELT(contents, 290, L_deathrt);
  SEXP L_dr = PROTECT(allocVector(REALSXP, internal->dim_L_dr));
  memcpy(REAL(L_dr), internal->L_dr, internal->dim_L_dr * sizeof(double));
  SET_VECTOR_ELT(contents, 291, L_dr);
  SET_VECTOR_ELT(contents, 292, ScalarReal(internal->ln_mean));
  ...
  SET_VECTOR_ELT(contents, 293, ln_pick);
  SET_VECTOR_ELT(contents, 294, ScalarReal(internal->ln_sd));
  ...
  SET_VECTOR_ELT(contents, 295, Lwb_birth);
  ...
  SET_VECTOR_ELT(contents, 296, Lwb_birth_lambda);
  ...
  SET_VECTOR_ELT(contents, 297, Lwb_mature);
  ...
  SET_VECTOR_ELT(contents, 298, Lwb_mature_prob);
  ...
  SET_VECTOR_ELT(contents, 299, Lwt_birth);
  ...
  SET_VECTOR_ELT(contents, 300, Lwt_birth_lambda);
  ...
  SET_VECTOR_ELT(contents, 301, Lwt_mature);
  ...
  SET_VECTOR_ELT(contents, 302, Lwt_mature_prob);
  ...
  SET_VECTOR_ELT(contents, 303, M_tot);
  ...
  SET_VECTOR_ELT(contents, 304, Mwb_E1_incub);
  ...
  SET_VECTOR_ELT(contents, 305, Mwb_E1_incub_prob);
  ...
  SET_VECTOR_ELT(contents, 306, Mwb_E2_incub);
  ...
  SET_VECTOR_ELT(contents, 307, Mwb_E2_incub_prob);
  ...
  SET_VECTOR_ELT(contents, 308, Mwb_FOI1);
  ...
  SET_VECTOR_ELT(contents, 309, Mwb_inf1);
  ...
  SET_VECTOR_ELT(contents, 310, Mwb_inf1_prob);
  ...
  SET_VECTOR_ELT(contents, 311, Mwb_intro);
  ...
  SET_VECTOR_ELT(contents, 312, Mwb_tot);
  SEXP Mwt = PROTECT(allocVector(REALSXP, internal->dim_Mwt));
  memcpy(REAL(Mwt), internal->Mwt, internal->dim_Mwt * sizeof(double));
  SET_VECTOR_ELT(contents, 313, Mwt);
  SET_VECTOR_ELT(contents, 314, ScalarReal(internal->Mwt_cv));
  ...
  SET_VECTOR_ELT(contents, 315, Mwt_E1_incub);
  ...
  SET_VECTOR_ELT(contents, 316, Mwt_E1_incub_prob);
  ...
  SET_VECTOR_ELT(contents, 317, Mwt_E2_incub);
  ...
  SET_VECTOR_ELT(contents, 318, Mwt_E2_incub_prob);
  ...
  SET_VECTOR_ELT(contents, 319, Mwt_FOI1);
  ...
  SET_VECTOR_ELT(contents, 320, Mwt_inf1);
  ...
  SET_VECTOR_ELT(contents, 321, Mwt_inf1_prob);
  SET_VECTOR_ELT(contents, 322, ScalarReal(internal->Mwt_mean));
  ...
  SET_VECTOR_ELT(contents, 325, n_I1);
  ...
  SET_VECTOR_ELT(contents, 326, n_R1);
  ...
  SET_VECTOR_ELT(contents, 327, n_S);
  SET_VECTOR_ELT(contents, 328, ScalarInteger(internal->na));
  SEXP Nb = PROTECT(allocVector(REALSXP, internal->dim_Nb));
  memcpy(REAL(Nb), internal->Nb, internal->dim_Nb * sizeof(double));
  SET_VECTOR_ELT(contents, 329, Nb);
  ...
  SET_VECTOR_ELT(contents, 330, nn);
  SET_VECTOR_ELT(contents, 331, ScalarInteger(internal->NP));
  ...
  SET_VECTOR_ELT(contents, 332, Ntotal);
  ...
  SET_VECTOR_ELT(contents, 333, Ntotal_sum);
  SEXP NTp = PROTECT(allocVector(REALSXP, internal->dim_NTp));
  memcpy(REAL(NTp), internal->NTp, internal->dim_NTp * sizeof(double));
  SET_VECTOR_ELT(contents, 334, NTp);
  SET_VECTOR_ELT(contents, 335, ScalarReal(internal->nu));
  ...
  SET_VECTOR_ELT(contents, 336, O_I1);
  ...
  SET_VECTOR_ELT(contents, 337, O_I1_prob);
  ...
  SET_VECTOR_ELT(contents, 338, O_Lwb);
  ...
  SET_VECTOR_ELT(contents, 339, O_Lwb_prob);
  ...
  SET_VECTOR_ELT(contents, 340, O_Lwt);
  ...
  SET_VECTOR_ELT(contents, 341, O_Lwt_prob);
  ...
  SET_VECTOR_ELT(contents, 342, O_Mwb_E1);
  ...
  SET_VECTOR_ELT(contents, 343, O_Mwb_E1_prob);
  ...
  SET_VECTOR_ELT(contents, 344, O_Mwb_E2);
  ...
  SET_VECTOR_ELT(contents, 345, O_Mwb_E2_prob);
  ...
  SET_VECTOR_ELT(contents, 346, O_Mwb_I1);
  ...
  SET_VECTOR_ELT(contents, 347, O_Mwb_I1_prob);
  ...
  SET_VECTOR_ELT(contents, 348, O_Mwb_S);
  ...
  SET_VECTOR_ELT(contents, 349, O_Mwb_S_prob);
  ...
  SET_VECTOR_ELT(contents, 350, O_Mwt_E1);
  ...
  SET_VECTOR_ELT(contents, 351, O_Mwt_E1_prob);
  ...
  SET_VECTOR_ELT(contents, 352, O_Mwt_E2);
  ...
  SET_VECTOR_ELT(contents, 353, O_Mwt_E2_prob);
  ...
  SET_VECTOR_ELT(contents, 354, O_Mwt_I1);
  ...
  SET_VECTOR_ELT(contents, 355, O_Mwt_I1_prob);
  ...
  SET_VECTOR_ELT(contents, 356, O_Mwt_S);
  ...
  SET_VECTOR_ELT(contents, 357, O_Mwt_S_prob);
  ...
  SET_VECTOR_ELT(contents, 358, O_R1);
  ...
  SET_VECTOR_ELT(contents, 359, O_R1_prob);
  ...
  SET_VECTOR_ELT(contents, 360, O_S);
  ...
  SET_VECTOR_ELT(contents, 361, O_S_prob);
  SET_VECTOR_ELT(contents, 362, ScalarInteger(internal->offset_output_Delta));
  SET_VECTOR_ELT(contents, 363, ScalarInteger(internal->offset_output_eip));
  SET_VECTOR_ELT(contents, 364, ScalarInteger(internal->offset_output_inf_1));
  SET_VECTOR_ELT(contents, 365, ScalarInteger(internal->offset_output_Kc));
  SET_VECTOR_ELT(contents, 366, ScalarInteger(internal->offset_output_Mwb_FOI1));
  SET_VECTOR_ELT(contents, 367, ScalarInteger(internal->offset_output_Mwt_FOI1));
  SET_VECTOR_ELT(contents, 368, ScalarInteger(internal->offset_output_prop_wb));
  SET_VECTOR_ELT(contents, 369, ScalarInteger(internal->offset_output_R0t_1));
  SET_VECTOR_ELT(contents, 370, ScalarInteger(internal->offset_variable_I1));
  SET_VECTOR_ELT(contents, 371, ScalarInteger(internal->offset_variable_incubA));
  SET_VECTOR_ELT(contents, 372, ScalarInteger(internal->offset_variable_incubB));
  SET_VECTOR_ELT(contents, 373, ScalarInteger(internal->offset_variable_infectiousA));
  SET_VECTOR_ELT(contents, 374, ScalarInteger(internal->offset_variable_infectiousB));
  SET_VECTOR_ELT(contents, 375, ScalarInteger(internal->offset_variable_Lwb));
  SET_VECTOR_ELT(contents, 376, ScalarInteger(internal->offset_variable_Mwb_E1));
  SET_VECTOR_ELT(contents, 377, ScalarInteger(internal->offset_variable_Mwb_E2));
  SET_VECTOR_ELT(contents, 378, ScalarInteger(internal->offset_variable_Mwb_I1));
  SET_VECTOR_ELT(contents, 379, ScalarInteger(internal->offset_variable_Mwb_S));
  SET_VECTOR_ELT(contents, 380, ScalarInteger(internal->offset_variable_Mwt_E1));
  SET_VECTOR_ELT(contents, 381, ScalarInteger(internal->offset_variable_Mwt_E2));
  SET_VECTOR_ELT(contents, 382, ScalarInteger(internal->offset_variable_Mwt_I1));
  SET_VECTOR_ELT(contents, 383, ScalarInteger(internal->offset_variable_R1));
  SET_VECTOR_ELT(contents, 384, ScalarInteger(internal->offset_variable_S));
  SET_VECTOR_ELT(contents, 385, ScalarReal(internal->Omega));
  SEXP phi1 = PROTECT(allocVector(REALSXP, internal->dim_phi1));
  memcpy(REAL(phi1), internal->phi1, internal->dim_phi1 * sizeof(double));
  SET_VECTOR_ELT(contents, 386, phi1);
  SET_VECTOR_ELT(contents, 387, ScalarReal(internal->pi));
  ...
  SET_VECTOR_ELT(contents, 388, prop_wb);
  SET_VECTOR_ELT(contents, 389, ScalarReal(internal->propMwtControl));
  SET_VECTOR_ELT(contents, 390, ScalarReal(internal->propTransGlobal));
  SET_VECTOR_ELT(contents, 391, ScalarReal(internal->propTransNN));
  ...
  SET_VECTOR_ELT(contents, 392, R0t_1);
  ...
  SET_VECTOR_ELT(contents, 393, recov1);
  ...
  SET_VECTOR_ELT(contents, 394, recov1_prob);
  SEXP rho1 = PROTECT(allocVector(REALSXP, internal->dim_rho1));
  memcpy(REAL(rho1), internal->rho1, internal->dim_rho1 * sizeof(double));
  SET_VECTOR_ELT(contents, 395, rho1);
  SET_VECTOR_ELT(contents, 396, ScalarReal(internal->Rm));
  ...
  SET_VECTOR_ELT(contents, 397, season_amp);
  ...
  SET_VECTOR_ELT(contents, 398, season_phases);
  SET_VECTOR_ELT(contents, 399, ScalarReal(internal->Sigma));
  SET_VECTOR_ELT(contents, 400, ScalarReal(internal->TimeMwtControlOff));
  SET_VECTOR_ELT(contents, 401, ScalarReal(internal->TimeMwtControlOn));
  ...
  SET_VECTOR_ELT(contents, 402, vacc_child_age);
  SET_VECTOR_ELT(contents, 403, ScalarReal(internal->vacc_child_coverage));
  SET_VECTOR_ELT(contents, 404, ScalarReal(internal->vacc_child_starttime));
  SET_VECTOR_ELT(contents, 405, ScalarReal(internal->vacc_child_stoptime));
  ...
  SET_VECTOR_ELT(contents, 406, vacc_cu_age);
  SET_VECTOR_ELT(contents, 407, ScalarReal(internal->vacc_cu_coverage));
  SET_VECTOR_ELT(contents, 408, ScalarReal(internal->vacc_cu_rndtime));
  ...
  SET_VECTOR_ELT(contents, 409, vacc_noncov);
  ...
  SET_VECTOR_ELT(contents, 410, vcu_noncov);
  SET_VECTOR_ELT(contents, 411, ScalarInteger(internal->vnc_row));
  SET_VECTOR_ELT(contents, 412, ScalarReal(internal->Wb_cyto));
  SET_VECTOR_ELT(contents, 413, ScalarReal(internal->Wb_fF));
  SET_VECTOR_ELT(contents, 414, ScalarReal(internal->Wb_fM));
  SET_VECTOR_ELT(contents, 415, ScalarReal(internal->Wb_introduration));
  SET_VECTOR_ELT(contents, 416, ScalarReal(internal->Wb_introlevel));
  ...
  SET_VECTOR_ELT(contents, 417, Wb_introrate);
  ...
  SET_VECTOR_ELT(contents, 418, Wb_introtime);
  SET_VECTOR_ELT(contents, 419, ScalarReal(internal->Wb_mat));
  SET_VECTOR_ELT(contents, 420, ScalarReal(internal->Wb_relinf1));
  SET_VECTOR_ELT(contents, 421, ScalarReal(internal->Wb_relsusc1));
  ...
  SET_VECTOR_ELT(contents, 424, Y1T_sum);
  SET_VECTOR_ELT(contents, 425, ScalarReal(internal->YL));
  SEXP nms = PROTECT(allocVector(STRSXP, 426));
  ...
  SET_STRING_ELT(nms, 113, mkChar("dim_M_tot"));
  SET_STRING_ELT(nms, 114, mkChar("dim_Mwb_E1"));
  SET_STRING_ELT(nms, 115, mkChar("dim_Mwb_E1_incub"));
  SET_STRING_ELT(nms, 116, mkChar("dim_Mwb_E1_incub_prob"));
  SET_STRING_ELT(nms, 117, mkChar("dim_Mwb_E2"));
  SET_STRING_ELT(nms, 118, mkChar("dim_Mwb_E2_incub"));
  SET_STRING_ELT(nms, 119, mkChar("dim_Mwb_E2_incub_prob"));
  SET_STRING_ELT(nms, 120, mkChar("dim_Mwb_FOI1"));
  SET_STRING_ELT(nms, 121, mkChar("dim_Mwb_I1"));
  SET_STRING_ELT(nms, 122, mkChar("dim_Mwb_inf1"));
  SET_STRING_ELT(nms, 123, mkChar("dim_Mwb_inf1_prob"));
  SET_STRING_ELT(nms, 124, mkChar("dim_Mwb_intro"));
  SET_STRING_ELT(nms, 125, mkChar("dim_Mwb_S"));
  SET_STRING_ELT(nms, 126, mkChar("dim_Mwb_tot"));
  SET_STRING_ELT(nms, 127, mkChar("dim_Mwt"));
  SET_STRING_ELT(nms, 128, mkChar("dim_Mwt_E1"));
  SET_STRING_ELT(nms, 129, mkChar("dim_Mwt_E1_incub"));
  SET_STRING_ELT(nms, 130, mkChar("dim_Mwt_E1_incub_prob"));
  SET_STRING_ELT(nms, 131, mkChar("dim_Mwt_E2"));
  SET_STRING_ELT(nms, 132, mkChar("dim_Mwt_E2_incub"));
  SET_STRING_ELT(nms, 133, mkChar("dim_Mwt_E2_incub_prob"));
  SET_STRING_ELT(nms, 134, mkChar("dim_Mwt_FOI1"));
  SET_STRING_ELT(nms, 135, mkChar("dim_Mwt_I1"));
  SET_STRING_ELT(nms, 136, mkChar("dim_Mwt_inf1"));
  SET_STRING_ELT(nms, 137, mkChar("dim_Mwt_inf1_prob"));
  SET_STRING_ELT(nms, 138, mkChar("dim_Mwt_S"));
  SET_STRING_ELT(nms, 139, mkChar("dim_Mwt_tot"));
  SET_STRING_ELT(nms, 140, mkChar("dim_N_eq"));
  SET_STRING_ELT(nms, 141, mkChar("dim_n_I1"));
  SET_STRING_ELT(nms, 142, mkChar("dim_n_I1_1"));
  SET_STRING_ELT(nms, 143, mkChar("dim_n_I1_12"));
  SET_STRING_ELT(nms, 144, mkChar("dim_n_I1_2"));
  SET_STRING_ELT(nms, 145, mkChar("dim_n_I1_3"));
  SET_STRING_ELT(nms, 146, mkChar("dim_n_R1"));
  SET_STRING_ELT(nms, 147, mkChar("dim_n_R1_1"));
  SET_STRING_ELT(nms, 148, mkChar("dim_n_R1_12"));
  SET_STRING_ELT(nms, 149, mkChar("dim_n_R1_2"));
  SET_STRING_ELT(nms, 150, mkChar("dim_n_R1_3"));
  SET_STRING_ELT(nms, 151, mkChar("dim_n_S"));
  SET_STRING_ELT(nms, 152, mkChar("dim_n_S_1"));
  SET_STRING_ELT(nms, 153, mkChar("dim_n_S_12"));
  SET_STRING_ELT(nms, 154, mkChar("dim_n_S_2"));
  SET_STRING_ELT(nms, 155, mkChar("dim_n_S_3"));
  SET_STRING_ELT(nms, 156, mkChar("dim_Nb"));
  SET_STRING_ELT(nms, 157, mkChar("dim_nn"));
  SET_STRING_ELT(nms, 158, mkChar("dim_nn_1"));
  SET_STRING_ELT(nms, 159, mkChar("dim_nn_2"));
  SET_STRING_ELT(nms, 160, mkChar("dim_Ntotal"));
  SET_STRING_ELT(nms, 161, mkChar("dim_Ntotal_1"));
  SET_STRING_ELT(nms, 162, mkChar("dim_Ntotal_12"));
  SET_STRING_ELT(nms, 163, mkChar("dim_Ntotal_2"));
  SET_STRING_ELT(nms, 164, mkChar("dim_Ntotal_3"));
  SET_STRING_ELT(nms, 165, mkChar("dim_Ntotal_sum"));
  SET_STRING_ELT(nms, 166, mkChar("dim_Ntotal_sum_1"));
  SET_STRING_ELT(nms, 167, mkChar("dim_Ntotal_sum_2"));
  SET_STRING_ELT(nms, 168, mkChar("dim_NTp"));
  SET_STRING_ELT(nms, 169, mkChar("dim_O_I1"));
  SET_STRING_ELT(nms, 170, mkChar("dim_O_I1_1"));
  SET_STRING_ELT(nms, 171, mkChar("dim_O_I1_12"));
  SET_STRING_ELT(nms, 172, mkChar("dim_O_I1_2"));
  SET_STRING_ELT(nms, 173, mkChar("dim_O_I1_3"));
  SET_STRING_ELT(nms, 174, mkChar("dim_O_I1_prob"));
  SET_STRING_ELT(nms, 175, mkChar("dim_O_Lwb"));
  SET_STRING_ELT(nms, 176, mkChar("dim_O_Lwb_prob"));
  SET_STRING_ELT(nms, 177, mkChar("dim_O_Lwt"));
  SET_STRING_ELT(nms, 178, mkChar("dim_O_Lwt_prob"));
  SET_STRING_ELT(nms, 179, mkChar("dim_O_Mwb_E1"));
  SET_STRING_ELT(nms, 180, mkChar("dim_O_Mwb_E1_prob"));
  SET_STRING_ELT(nms, 181, mkChar("dim_O_Mwb_E2"));
  SET_STRING_ELT(nms, 182, mkChar("dim_O_Mwb_E2_prob"));
  SET_STRING_ELT(nms, 183, mkChar("dim_O_Mwb_I1"));
  SET_STRING_ELT(nms, 184, mkChar("dim_O_Mwb_I1_prob"));
  SET_STRING_ELT(nms, 185, mkChar("dim_O_Mwb_S"));
  SET_STRING_ELT(nms, 186, mkChar("dim_O_Mwb_S_prob"));
  SET_STRING_ELT(nms, 187, mkChar("dim_O_Mwt_E1"));
  SET_STRING_ELT(nms, 188, mkChar("dim_O_Mwt_E1_prob"));
  SET_STRING_ELT(nms, 189, mkChar("dim_O_Mwt_E2"));
  SET_STRING_ELT(nms, 190, mkChar("dim_O_Mwt_E2_prob"));
  SET_STRING_ELT(nms, 191, mkChar("dim_O_Mwt_I1"));
  SET_STRING_ELT(nms, 192, mkChar("dim_O_Mwt_I1_prob"));
  SET_STRING_ELT(nms, 193, mkChar("dim_O_Mwt_S"));
  SET_STRING_ELT(nms, 194, mkChar("dim_O_Mwt_S_prob"));
  SET_STRING_ELT(nms, 195, mkChar("dim_O_R1"));
  SET_STRING_ELT(nms, 196, mkChar("dim_O_R1_1"));
  SET_STRING_ELT(nms, 197, mkChar("dim_O_R1_12"));
  SET_STRING_ELT(nms, 198, mkChar("dim_O_R1_2"));
  SET_STRING_ELT(nms, 199, mkChar("dim_O_R1_3"));
  SET_STRING_ELT(nms, 200, mkChar("dim_O_R1_prob"));
  SET_STRING_ELT(nms, 201, mkChar("dim_O_S"));
  SET_STRING_ELT(nms, 202, mkChar("dim_O_S_1"));
  SET_STRING_ELT(nms, 203, mkChar("dim_O_S_12"));
  SET_STRING_ELT(nms, 204, mkChar("dim_O_S_2"));
  SET_STRING_ELT(nms, 205, mkChar("dim_O_S_3"));
  SET_STRING_ELT(nms, 206, mkChar("dim_O_S_prob"));
  SET_STRING_ELT(nms, 207, mkChar("dim_O_S_prob_1"));
  SET_STRING_ELT(nms, 208, mkChar("dim_O_S_prob_12"));
  SET_STRING_ELT(nms, 209, mkChar("dim_O_S_prob_2"));
  SET_STRING_ELT(nms, 210, mkChar("dim_O_S_prob_3"));
  SET_STRING_ELT(nms, 211, mkChar("dim_phi1"));
  SET_STRING_ELT(nms, 212, mkChar("dim_prop_wb"));
  SET_STRING_ELT(nms, 213, mkChar("dim_R0t_1"));
  SET_STRING_ELT(nms, 214, mkChar("dim_R1"));
  SET_STRING_ELT(nms, 215, mkChar("dim_R1_1"));
  SET_STRING_ELT(nms, 216, mkChar("dim_R1_12"));
  SET_STRING_ELT(nms, 217, mkChar("dim_R1_2"));
  SET_STRING_ELT(nms, 218, mkChar("dim_R1_3"));
  SET_STRING_ELT(nms, 219, mkChar("dim_recov1"));
  SET_STRING_ELT(nms, 220, mkChar("dim_recov1_1"));
  SET_STRING_ELT(nms, 221, mkChar("dim_recov1_12"));
  SET_STRING_ELT(nms, 222, mkChar("dim_recov1_2"));
  SET_STRING_ELT(nms, 223, mkChar("dim_recov1_3"));
  SET_STRING_ELT(nms, 224, mkChar("dim_recov1_prob"));
  SET_STRING_ELT(nms, 225, mkChar("dim_rho1"));
  SET_STRING_ELT(nms, 226, mkChar("dim_S"));
  SET_STRING_ELT(nms, 227, mkChar("dim_S_1"));
  SET_STRING_ELT(nms, 228, mkChar("dim_S_12"));
  SET_STRING_ELT(nms, 229, mkChar("dim_S_2"));
  SET_STRING_ELT(nms, 230, mkChar("dim_S_3"));
  SET_STRING_ELT(nms, 231, mkChar("dim_season_amp"));
  SET_STRING_ELT(nms, 232, mkChar("dim_season_phases"));
  SET_STRING_ELT(nms, 233, mkChar("dim_vacc_child_age"));
  SET_STRING_ELT(nms, 234, mkChar("dim_vacc_cu_age"));
  SET_STRING_ELT(nms, 235, mkChar("dim_vacc_noncov"));
  SET_STRING_ELT(nms, 236, mkChar("dim_vacc_noncov_1"));
  SET_STRING_ELT(nms, 237, mkChar("dim_vacc_noncov_2"));
  SET_STRING_ELT(nms, 238, mkChar("dim_vcu_noncov"));
  SET_STRING_ELT(nms, 239, mkChar("dim_vcu_noncov_1"));
  SET_STRING_ELT(nms, 240, mkChar("dim_vcu_noncov_2"));
  SET_STRING_ELT(nms, 241, mkChar("dim_Wb_introrate"));
  SET_STRING_ELT(nms, 242, mkChar("dim_Wb_introtime"));
  SET_STRING_ELT(nms, 243, mkChar("dim_Y1"));
  SET_STRING_ELT(nms, 244, mkChar("dim_Y1_1"));
  SET_STRING_ELT(nms, 245, mkChar("dim_Y1_12"));
  SET_STRING_ELT(nms, 246, mkChar("dim_Y1_2"));
  SET_STRING_ELT(nms, 247, mkChar("dim_Y1_3"));
  SET_STRING_ELT(nms, 248, mkChar("dim_Y1T"));
  SET_STRING_ELT(nms, 249, mkChar("dim_Y1T_sum"));
  SET_STRING_ELT(nms, 250, mkChar("dim_Y1T_sum_1"));
  SET_STRING_ELT(nms, 251, mkChar("dim_Y1T_sum_2"));
  SET_STRING_ELT(nms, 252, mkChar("DT"));
  SET_STRING_ELT(nms, 253, mkChar("eip"));
  SET_STRING_ELT(nms, 254, mkChar("eip_mean"));
  SET_STRING_ELT(nms, 255, mkChar("eip_season"));
  SET_STRING_ELT(nms, 256, mkChar("Epsilon"));
  SET_STRING_ELT(nms, 257, mkChar("FOI1"));
  SET_STRING_ELT(nms, 258, mkChar("FOI1nn"));
  SET_STRING_ELT(nms, 259, mkChar("FOI1p"));
  SET_STRING_ELT(nms, 260, mkChar("Gamma"));
  SET_STRING_ELT(nms, 261, mkChar("incub"));
  SET_STRING_ELT(nms, 262, mkChar("inf_1"));
  SET_STRING_ELT(nms, 263, mkChar("inf_1_prob"));
  SET_STRING_ELT(nms, 264, mkChar("inf_per"));
  SET_STRING_ELT(nms, 265, mkChar("infectious1"));
  SET_STRING_ELT(nms, 266, mkChar("init_I1"));
  SET_STRING_ELT(nms, 267, mkChar("init_R1"));
  SET_STRING_ELT(nms, 268, mkChar("init_S"));
  SET_STRING_ELT(nms, 269, mkChar("initial_I1"));
  SET_STRING_ELT(nms, 270, mkChar("initial_incubA"));
  SET_STRING_ELT(nms, 271, mkChar("initial_incubB"));
  SET_STRING_ELT(nms, 272, mkChar("initial_infectiousA"));
  SET_STRING_ELT(nms, 273, mkChar("initial_infectiousB"));
  SET_STRING_ELT(nms, 274, mkChar("initial_Lwb"));
  SET_STRING_ELT(nms, 275, mkChar("initial_Lwt"));
  SET_STRING_ELT(nms, 276, mkChar("initial_Mwb_E1"));
  SET_STRING_ELT(nms, 277, mkChar("initial_Mwb_E2"));
  SET_STRING_ELT(nms, 278, mkChar("initial_Mwb_I1"));
  SET_STRING_ELT(nms, 279, mkChar("initial_Mwb_S"));
  SET_STRING_ELT(nms, 280, mkChar("initial_Mwt_E1"));
  SET_STRING_ELT(nms, 281, mkChar("initial_Mwt_E2"));
  SET_STRING_ELT(nms, 282, mkChar("initial_Mwt_I1"));
  SET_STRING_ELT(nms, 283, mkChar("initial_Mwt_S"));
  SET_STRING_ELT(nms, 284, mkChar("initial_R1"));
  SET_STRING_ELT(nms, 285, mkChar("initial_S"));
  SET_STRING_ELT(nms, 286, mkChar("Kappa"));
  SET_STRING_ELT(nms, 287, mkChar("Kc"));
  SET_STRING_ELT(nms, 288, mkChar("Kc_mean"));
  SET_STRING_ELT(nms, 289, mkChar("Kc_season"));
  SET_STRING_ELT(nms, 290, mkChar("L_deathrt"));
  SET_STRING_ELT(nms, 291, mkChar("L_dr"));
  SET_STRING_ELT(nms, 292, mkChar("ln_mean"));
  SET_STRING_ELT(nms, 293, mkChar("ln_pick"));
  SET_STRING_ELT(nms, 294, mkChar("ln_sd"));
  SET_STRING_ELT(nms, 295, mkChar("Lwb_birth"));
  SET_STRING_ELT(nms, 296, mkChar("Lwb_birth_lambda"));
  SET_STRING_ELT(nms, 297, mkChar("Lwb_mature"));
  SET_STRING_ELT(nms, 298, mkChar("Lwb_mature_prob"));
  SET_STRING_ELT(nms, 299, mkChar("Lwt_birth"));
  SET_STRING_ELT(nms, 300, mkChar("Lwt_birth_lambda"));
  SET_STRING_ELT(nms, 301, mkChar("Lwt_mature"));
  SET_STRING_ELT(nms, 302, mkChar("Lwt_mature_prob"));
  SET_STRING_ELT(nms, 303, mkChar("M_tot"));
  SET_STRING_ELT(nms, 304, mkChar("Mwb_E1_incub"));
  SET_STRING_ELT(nms, 305, mkChar("Mwb_E1_incub_prob"));
  SET_STRING_ELT(nms, 306, mkChar("Mwb_E2_incub"));
  SET_STRING_ELT(nms, 307, mkChar("Mwb_E2_incub_prob"));
  SET_STRING_ELT(nms, 308, mkChar("Mwb_FOI1"));
  SET_STRING_ELT(nms, 309, mkChar("Mwb_inf1"));
  SET_STRING_ELT(nms, 310, mkChar("Mwb_inf1_prob"));
  SET_STRING_ELT(nms, 311, mkChar("Mwb_intro"));
  SET_STRING_ELT(nms, 312, mkChar("Mwb_tot"));
  SET_STRING_ELT(nms, 313, mkChar("Mwt"));
  SET_STRING_ELT(nms, 314, mkChar("Mwt_cv"));
  SET_STRING_ELT(nms, 315, mkChar("Mwt_E1_incub"));
  SET_STRING_ELT(nms, 316, mkChar("Mwt_E1_incub_prob"));
  SET_STRING_ELT(nms, 317, mkChar("Mwt_E2_incub"));
  SET_STRING_ELT(nms, 318, mkChar("Mwt_E2_incub_prob"));
  SET_STRING_ELT(nms, 319, mkChar("Mwt_FOI1"));
  SET_STRING_ELT(nms, 320, mkChar("Mwt_inf1"));
  SET_STRING_ELT(nms, 321, mkChar("Mwt_inf1_prob"));
  SET_STRING_ELT(nms, 322, mkChar("Mwt_mean"));
  SET_STRING_ELT(nms, 323, mkChar("Mwt_tot"));
  SET_STRING_ELT(nms, 324, mkChar("N_eq"));
  SET_STRING_ELT(nms, 325, mkChar("n_I1"));
  SET_STRING_ELT(nms, 326, mkChar("n_R1"));
  SET_STRING_ELT(nms, 327, mkChar("n_S"));
  SET_STRING_ELT(nms, 328, mkChar("na"));
  SET_STRING_ELT(nms, 329, mkChar("Nb"));
  SET_STRING_ELT(nms, 330, mkChar("nn"));
  SET_STRING_ELT(nms, 331, mkChar("NP"));
  SET_STRING_ELT(nms, 332, mkChar("Ntotal"));
  SET_STRING_ELT(nms, 333, mkChar("Ntotal_sum"));
  SET_STRING_ELT(nms, 334, mkChar("NTp"));
  SET_STRING_ELT(nms, 335, mkChar("nu"));
  SET_STRING_ELT(nms, 336, mkChar("O_I1"));
  SET_STRING_ELT(nms, 337, mkChar("O_I1_prob"));
  SET_STRING_ELT(nms, 338, mkChar("O_Lwb"));
  SET_STRING_ELT(nms, 339, mkChar("O_Lwb_prob"));
  SET_STRING_ELT(nms, 340, mkChar("O_Lwt"));
  SET_STRING_ELT(nms, 341, mkChar("O_Lwt_prob"));
  SET_STRING_ELT(nms, 342, mkChar("O_Mwb_E1"));
  SET_STRING_ELT(nms, 343, mkChar("O_Mwb_E1_prob"));
  SET_STRING_ELT(nms, 344, mkChar("O_Mwb_E2"));
  SET_STRING_ELT(nms, 345, mkChar("O_Mwb_E2_prob"));
  SET_STRING_ELT(nms, 346, mkChar("O_Mwb_I1"));
  SET_STRING_ELT(nms, 347, mkChar("O_Mwb_I1_prob"));
  SET_STRING_ELT(nms, 348, mkChar("O_Mwb_S"));
  SET_STRING_ELT(nms, 349, mkChar("O_Mwb_S_prob"));
  SET_STRING_ELT(nms, 350, mkChar("O_Mwt_E1"));
  SET_STRING_ELT(nms, 351, mkChar("O_Mwt_E1_prob"));
  SET_STRING_ELT(nms, 352, mkChar("O_Mwt_E2"));
  SET_STRING_ELT(nms, 353, mkChar("O_Mwt_E2_prob"));
  SET_STRING_ELT(nms, 354, mkChar("O_Mwt_I1"));
  SET_STRING_ELT(nms, 355, mkChar("O_Mwt_I1_prob"));
  SET_STRING_ELT(nms, 356, mkChar("O_Mwt_S"));
  SET_STRING_ELT(nms, 357, mkChar("O_Mwt_S_prob"));
  SET_STRING_ELT(nms, 358, mkChar("O_R1"));
  SET_STRING_ELT(nms, 359, mkChar("O_R1_prob"));
  SET_STRING_ELT(nms, 360, mkChar("O_S"));
  SET_STRING_ELT(nms, 361, mkChar("O_S_prob"));
  SET_STRING_ELT(nms, 362, mkChar("offset_output_Delta"));
  SET_STRING_ELT(nms, 363, mkChar("offset_output_eip"));
  SET_STRING_ELT(nms, 364, mkChar("offset_output_inf_1"));
  SET_STRING_ELT(nms, 365, mkChar("offset_output_Kc"));
  SET_STRING_ELT(nms, 366, mkChar("offset_output_Mwb_FOI1"));
  SET_STRING_ELT(nms, 367, mkChar("offset_output_Mwt_FOI1"));
  SET_STRING_ELT(nms, 368, mkChar("offset_output_prop_wb"));
  SET_STRING_ELT(nms, 369, mkChar("offset_output_R0t_1"));
  SET_STRING_ELT(nms, 370, mkChar("offset_variable_I1"));
  SET_STRING_ELT(nms, 371, mkChar("offset_variable_incubA"));
  SET_STRING_ELT(nms, 372, mkChar("offset_variable_incubB"));
  SET_STRING_ELT(nms, 373, mkChar("offset_variable_infectiousA"));
  SET_STRING_ELT(nms, 374, mkChar("offset_variable_infectiousB"));
  SET_STRING_ELT(nms, 375, mkChar("offset_variable_Lwb"));
  SET_STRING_ELT(nms, 376, mkChar("offset_variable_Mwb_E1"));
  SET_STRING_ELT(nms, 377, mkChar("offset_variable_Mwb_E2"));
  SET_STRING_ELT(nms, 378, mkChar("offset_variable_Mwb_I1"));
  SET_STRING_ELT(nms, 379, mkChar("offset_variable_Mwb_S"));
  SET_STRING_ELT(nms, 380, mkChar("offset_variable_Mwt_E1"));
  SET_STRING_ELT(nms, 381, mkChar("offset_variable_Mwt_E2"));
  SET_STRING_ELT(nms, 382, mkChar("offset_variable_Mwt_I1"));
  SET_STRING_ELT(nms, 383, mkChar("offset_variable_R1"));
  SET_STRING_ELT(nms, 384, mkChar("offset_variable_S"));
  SET_STRING_ELT(nms, 385, mkChar("Omega"));
  SET_STRING_ELT(nms, 386, mkChar("phi1"));
  SET_STRING_ELT(nms, 387, mkChar("pi"));
  SET_STRING_ELT(nms, 388, mkChar("prop_wb"));
  SET_STRING_ELT(nms, 389, mkChar("propMwtControl"));
  SET_STRING_ELT(nms, 390, mkChar("propTransGlobal"));
  SET_STRING_ELT(nms, 391, mkChar("propTransNN"));
  SET_STRING_ELT(nms, 392, mkChar("R0t_1"));
  SET_STRING_ELT(nms, 393, mkChar("recov1"));
  SET_STRING_ELT(nms, 394, mkChar("recov1_prob"));
  SET_STRING_ELT(nms, 395, mkChar("rho1"));
  SET_STRING_ELT(nms, 396, mkChar("Rm"));
  SET_STRING_ELT(nms, 397, mkChar("season_amp"));
  SET_STRING_ELT(nms, 398, mkChar("season_phases"));
  SET_STRING_ELT(nms, 399, mkChar("Sigma"));
  SET_STRING_ELT(nms, 400, mkChar("TimeMwtControlOff"));
  SET_STRING_ELT(nms, 401, mkChar("TimeMwtControlOn"));
  SET_STRING_ELT(nms, 402, mkChar("vacc_child_age"));
  SET_STRING_ELT(nms, 403, mkChar("vacc_child_coverage"));
  SET_STRING_ELT(nms, 404, mkChar("vacc_child_starttime"));
  SET_STRING_ELT(nms, 405, mkChar("vacc_child_stoptime"));
  SET_STRING_ELT(nms, 406, mkChar("vacc_cu_age"));
  SET_STRING_ELT(nms, 407, mkChar("vacc_cu_coverage"));
  SET_STRING_ELT(nms, 408, mkChar("vacc_cu_rndtime"));
  SET_STRING_ELT(nms, 409, mkChar("vacc_noncov"));
  SET_STRING_ELT(nms, 410, mkChar("vcu_noncov"));
  SET_STRING_ELT(nms, 411, mkChar("vnc_row"));
  SET_STRING_ELT(nms, 412, mkChar("Wb_cyto"));
  SET_STRING_ELT(nms, 413, mkChar("Wb_fF"));
  SET_STRING_ELT(nms, 414, mkChar("Wb_fM"));
  SET_STRING_ELT(nms, 415, mkChar("Wb_introduration"));
  SET_STRING_ELT(nms, 416, mkChar("Wb_introlevel"));
  SET_STRING_ELT(nms, 417, mkChar("Wb_introrate"));
  SET_STRING_ELT(nms, 418, mkChar("Wb_introtime"));
  SET_STRING_ELT(nms, 419, mkChar("Wb_mat"));
  SET_STRING_ELT(nms, 420, mkChar("Wb_relinf1"));
  SET_STRING_ELT(nms, 421, mkChar("Wb_relsusc1"));
  SET_STRING_ELT(nms, 422, mkChar("Y1"));
  SET_STRING_ELT(nms, 423, mkChar("Y1T"));
  SET_STRING_ELT(nms, 424, mkChar("Y1T_sum"));
  SET_STRING_ELT(nms, 425, mkChar("YL"));
...
SEXP odin_model_determ_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->offset_output_inf_1 = 1 + internal->dim_FOI1p + internal->dim_R0t_1 + internal->dim_Delta + internal->dim_Kc + internal->dim_eip + internal->dim_Mwt_FOI1 + internal->dim_Mwb_FOI1 + internal->dim_prop_wb;
  internal->offset_output_Kc = 1 + internal->dim_FOI1p + internal->dim_R0t_1 + internal->dim_Delta;
  internal->offset_output_Mwb_FOI1 = 1 + internal->dim_FOI1p + internal->dim_R0t_1 + internal->dim_Delta + internal->dim_Kc + internal->dim_eip + internal->dim_Mwt_FOI1;
  internal->offset_output_Mwt_FOI1 = 1 + internal->dim_FOI1p + internal->dim_R0t_1 + internal->dim_Delta + internal->dim_Kc + internal->dim_eip;
  internal->offset_output_prop_wb = 1 + internal->dim_FOI1p + internal->dim_R0t_1 + internal->dim_Delta + internal->dim_Kc + internal->dim_eip + internal->dim_Mwt_FOI1 + internal->dim_Mwb_FOI1;
...
SEXP odin_model_determ_metadata(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(output_length, 6, ScalarInteger(internal->dim_Mwt_FOI1));
  SET_VECTOR_ELT(output_length, 7, ScalarInteger(internal->dim_Mwb_FOI1));
  SET_VECTOR_ELT(output_length, 8, ScalarInteger(internal->dim_prop_wb));
  SET_VECTOR_ELT(output_length, 9, allocVector(INTSXP, 3));
  int * dim_inf_1 = INTEGER(VECTOR_ELT(output_length, 9));
  ...
  SET_STRING_ELT(output_names, 6, mkChar("Mwt_FOI1"));
  SET_STRING_ELT(output_names, 7, mkChar("Mwb_FOI1"));
  SET_STRING_ELT(output_names, 8, mkChar("prop_wb"));
  SET_STRING_ELT(output_names, 9, mkChar("inf_1"));
  SET_VECTOR_ELT(ret, 1, output_length);
  UNPROTECT(2);
  SET_VECTOR_ELT(ret, 2, ScalarInteger(1 + internal->dim_FOI1p + internal->dim_R0t_1 + internal->dim_Delta + internal->dim_Kc + internal->dim_eip + internal->dim_Mwt_FOI1 + internal->dim_Mwb_FOI1 + internal->dim_prop_wb + internal->dim_inf_1));
  UNPROTECT(2);
  return ret;
}
SEXP odin_model_determ_initial_conditions(SEXP internal_p, SEXP step_ptr) {
...
void odin_model_determ_rhs(odin_model_determ_internal* internal, size_t step, double * state, double * state_next, double * output) {
  ...
  memcpy(output + internal->offset_output_Mwb_FOI1, internal->Mwb_FOI1, internal->dim_Mwb_FOI1 * sizeof(double));
...
SEXP odin_model_determ_rhs_r(SEXP internal_p, SEXP step, SEXP state) {
  ...
  odin_model_determ_internal *internal = odin_model_determ_get_internal(internal_p, 1);
  SEXP output_ptr = PROTECT(allocVector(REALSXP, 1 + internal->dim_FOI1p + internal->dim_R0t_1 + internal->dim_Delta + internal->dim_Kc + internal->dim_eip + internal->dim_Mwt_FOI1 + internal->dim_Mwb_FOI1 + internal->dim_prop_wb + internal->dim_inf_1));
