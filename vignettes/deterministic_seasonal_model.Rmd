...
```
<br>
We first create all the objects required to run a base model:
...
A deterministic model which includes the effect of seasonality can be implemented by setting to `TRUE` the `season` argument of `run_model()`.
